...
-- Decompiled on 2025-07-21 08:39:22
-- Luau version 6, Types version 3
-- Time taken: 0.004542 seconds
...
function setmetatable_result1_upvr.new(arg1) -- Line 21
	--[[ Upvalues[3]:
...
function setmetatable_result1_upvr.Enable(arg1, arg2) -- Line 37
	--[[ Upvalues[2]:
...
function setmetatable_result1_upvr.GetHighestPriorityGamepad(arg1) -- Line 77
	--[[ Upvalues[2]:
		[1]: UserInputService_upvr (readonly)
		[2]: None_upvr (readonly)
	]]
...
function setmetatable_result1_upvr.BindContextActions(arg1) -- Line 88
	--[[ Upvalues[2]:
	...
	ContextActionService_upvr:BindActionAtPriority("jumpAction", function(arg1_2, arg2, arg3) -- Line 95
		--[[ Upvalues[1]:
			[1]: arg1 (readonly)
		]]
		local var16
	...
	ContextActionService_upvr:BindActionAtPriority("moveThumbstick", function(arg1_3, arg2, arg3) -- Line 100
		--[[ Upvalues[1]:
			[1]: arg1 (readonly)
		]]
...
function setmetatable_result1_upvr.UnbindContextActions(arg1) -- Line 129
	--[[ Upvalues[2]:
		[1]: None_upvr (readonly)
		[2]: ContextActionService_upvr (readonly)
	]]
...
function setmetatable_result1_upvr.OnNewGamepadConnected(arg1) -- Line 137
	--[[ Upvalues[1]:
		[1]: None_upvr (readonly)
	]]
...
function setmetatable_result1_upvr.OnCurrentGamepadDisconnected(arg1) -- Line 164
	--[[ Upvalues[2]:
		[1]: None_upvr (readonly)
		[2]: ContextActionService_upvr (readonly)
	]]
...
function setmetatable_result1_upvr.ConnectGamepadConnectionListeners(arg1) -- Line 189
	--[[ Upvalues[1]:
		[1]: UserInputService_upvr (readonly)
	]]
	arg1.gamepadConnectedConn = UserInputService_upvr.GamepadConnected:Connect(function(arg1_4) -- Line 190
		--[[ Upvalues[1]:
			[1]: arg1 (readonly)
		]]
		arg1:OnNewGamepadConnected()
	end)
	arg1.gamepadDisconnectedConn = UserInputService_upvr.GamepadDisconnected:Connect(function(arg1_5) -- Line 194
		--[[ Upvalues[1]:
			[1]: arg1 (readonly)
		]]
...
function setmetatable_result1_upvr.DisconnectGamepadConnectionListeners(arg1) -- Line 202
