...
function module_6_upvr.SelectAdToDisplay(arg1, arg2) -- Line 153
	...
	local module_7 = {}
	local var40 = 0
	local _, ipairs_result2_4, ipairs_result3_3 = ipairs(arg2)
	local var44
	for i_2, v_2 in var44, ipairs_result2_4, ipairs_result3_3 do
	...
	return FilterUtils_upvr.PythonChoices(module_3, module_7)[1]
end
...
function module_6_upvr.GetAds(arg1, arg2, arg3) -- Line 208
	...
	var79 = arg2
	FilterUtils_upvr.ValidateParams(GET_ADS_PARAMETERS_upvr, var79)
	local players = arg2.players
	arg2.players = nil
	local var87 = arg3
	if not var87 then
		var87 = module_6_upvr:GetAllEnabledAds()
	end
	var79 = Filters_upvr:FilterAdsByAdFormat(var87, tbl_3)
	var79 = Filters_upvr:FilterAdsByGameTargeting(var79, tonumber(arg2.bloxbiz_version or 0), arg2.part_name)
	if var81 then
		var79 = Filters_upvr:FilterAdsBySizePortal(var79, part_size_x, part_size_y, part_size_z)
		-- KONSTANTWARNING: GOTO [170] #131
	end
	if var80 then
		var79 = Filters_upvr:FilterAdsBySize3D(var79, part_size_x, part_size_y, part_size_z)
	else
		var79 = Filters_upvr:FilterAdsBySize2D(var79, tonumber(tostring(FilterUtils_upvr.Round(FilterUtils_upvr.SafeDiv(arg2.surface_gui_size_y or 0, arg2.surface_gui_size_x or 0), 4))))
	end
	var79 = Filters_upvr:FilterAdsByBlocklist(var79, {})
	local module_4 = {}
	for _, v_3 in ipairs(players) do
		table.insert({}, v_3.player_id)
		local var93
	end
	for _, v_4 in ipairs(var93) do
	...
	for _, v_5 in ipairs(players) do
		...
		local var105 = var97[player_id]
		local var106
		if var81 then
			var106 = arg1:BuildPortalAdItem(module_6_upvr:SelectAdToDisplay(Filters_upvr:FilterAdsByPlayerId(Filters_upvr:FilterAdsByFreqCap(Filters_upvr:FilterAdsByExternalLinks(Filters_upvr:FilterAdsByPlayerTargeting(var79, v_5.country_code, player_locale_id, v_5.player_membership_type, any_GetDeviceType_result1, var105, v_5.are_ads_allowed), allowed_external_link_references), player_id), player_id)), module_6_upvr:GetAdDisclaimer(player_locale_id))
		elseif var80 then
			-- KONSTANTERROR: Expression was reused, decompilation is incorrect (x2)
			var106 = arg1:Build3DAdItem(module_6_upvr:SelectAdToDisplay(Filters_upvr:FilterAdsByPlayerId(Filters_upvr:FilterAdsByFreqCap(Filters_upvr:FilterAdsByExternalLinks(Filters_upvr:FilterAdsByPlayerTargeting(var79, v_5.country_code, player_locale_id, v_5.player_membership_type, any_GetDeviceType_result1, var105, v_5.are_ads_allowed), allowed_external_link_references), player_id), player_id)), module_6_upvr:GetAdDisclaimer(player_locale_id))
		else
			-- KONSTANTERROR: Expression was reused, decompilation is incorrect (x2)
			var106 = arg1:Build2DAdItem(module_6_upvr:SelectAdToDisplay(Filters_upvr:FilterAdsByPlayerId(Filters_upvr:FilterAdsByFreqCap(Filters_upvr:FilterAdsByExternalLinks(Filters_upvr:FilterAdsByPlayerTargeting(var79, v_5.country_code, player_locale_id, v_5.player_membership_type, any_GetDeviceType_result1, var105, v_5.are_ads_allowed), allowed_external_link_references), player_id), player_id)), module_6_upvr:GetAdDisclaimer(player_locale_id))
		end
		module_4[player_id] = var106
		FilterUtils_upvr.ValidateParams(GET_ADS_PLAYER_PARAMETERS_upvr, v_5)
		local var107 = v_5
		var107.player_device = any_GetDeviceType_result1
		var107.gender = var105
		var107.ad_url = var106.ad_url
		var107.bloxbiz_ad_id = var106.bloxbiz_ad_id
		var107.timestamp = tonumber(os.time())
		FilterUtils_upvr.PythonUpdate(var107, arg2)
		table.insert({}, FilterUtils_upvr.CapIntegerValues(var107))
	end
	Utils_upvr.pprint("[SuperBiz] Ads delivered to "..FilterUtils_upvr.CountDictionary(module_4).." players in game ("..arg2.game_id..") (Took "..FilterUtils_upvr.Round(tick() - tick(), 2).."s)")
	return module_4
end
