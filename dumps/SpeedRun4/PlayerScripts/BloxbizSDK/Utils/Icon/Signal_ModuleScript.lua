...
-- Decompiled on 2025-07-21 08:39:59
-- Luau version 6, Types version 3
-- Time taken: 0.004732 seconds
...
local var3_upvw
local function RunHandlerInFreeThread_upvr(arg1, ...) -- Line 50, Named "RunHandlerInFreeThread"
	--[[ Upvalues[1]:
...
local function CreateFreeThread_upvr() -- Line 59, Named "CreateFreeThread"
	--[[ Upvalues[2]:
		[1]: var3_upvw (read and write)
...
function module_upvr.new() -- Line 73
	--[[ Upvalues[1]:
...
function module_upvr.Is(arg1) -- Line 95
	--[[ Upvalues[1]:
		[1]: module_upvr (readonly)
	]]
	local var5 = false
...
function module_upvr.IsActive(arg1) -- Line 112
	local var6
...
function module_upvr.Connect(arg1, arg2) -- Line 134
	--[[ Upvalues[1]:
		[1]: tbl_upvr (readonly)
	]]
	local var7
...
function module_upvr.ConnectOnce(arg1, arg2) -- Line 195
	local var11
	if typeof(arg2) ~= "function" then
		var11 = false
	else
...
function module_upvr.Wait(arg1) -- Line 228
	local var15_upvw
	local current_thread_upvw = coroutine.running()
	var15_upvw = arg1:Connect(function(...) -- Line 233
		--[[ Upvalues[2]:
...
function module_upvr.Fire(arg1, ...) -- Line 258
	--[[ Upvalues[2]:
		[1]: var3_upvw (read and write)
...
function module_upvr.DisconnectAll(arg1) -- Line 289
...
function module_upvr.Destroy(arg1) -- Line 318
	if arg1._active ~= true then
	else
		arg1:DisconnectAll()
		arg1._active = false
...
function tbl_upvr.Disconnect(arg1) -- Line 341
...
tbl_upvr.Destroy = tbl_upvr.Disconnect
tbl_upvr.disconnect = tbl_upvr.Disconnect
