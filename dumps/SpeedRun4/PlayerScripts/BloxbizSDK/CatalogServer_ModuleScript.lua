...
local function InitCategoryItems_upvr() -- Line 81, Named "InitCategoryItems"
	...
	RemoteFunction_4.Parent = ReplicatedStorage_upvr:WaitForChild("BloxbizRemotes")
	RemoteFunction_4.Name = "GetCatalogCategories"
	function RemoteFunction_4.OnServerInvoke() -- Line 90
		--[[ Upvalues[1]:
	...
	for _, v in var21_upvw do
		for _, v_2 in v.subcategories do
			if v_2.query.Category then
				tbl_3_upvr[v_2.name] = CategoryClass_upvr.new(v_2)
			end
		end
	end
end
local function ItemsResponse_upvr(arg1, arg2) -- Line 105, Named "ItemsResponse"
	...
	local var46 = tbl_3_upvr[Category]
...
local function SaveOutfit_upvr(arg1, arg2, arg3) -- Line 295, Named "SaveOutfit"
	...
	tbl_4.InnerValue = arg2
	DataManager_upvr.SetData(arg1, "Outfits", tbl_4)
	return true
end
...
function module.Init() -- Line 425
	...
	RemoteFunction_5.Name = "CatalogOnSearchItemsRequest"
	RemoteFunction_5.OnServerInvoke = SearchItemsReponse_upvr
	RemoteFunction_5.Parent = ReplicatedStorage_upvr.BloxbizRemotes
	...
	RemoteFunction_6.Name = "CatalogOnSaveOutfit"
	RemoteFunction_6.OnServerInvoke = SaveOutfit_upvr
	...
	RemoteFunction_3.Name = "CatalogOnPromptPurchase"
	RemoteFunction_3.OnServerInvoke = PromptPurchase_upvr
	...
	if tbl_upvr_3.PersistentWear then
		...
		local function onPlayerAdded(arg1) -- Line 500
			...
			tbl_2_upvr[arg1] = Utils_upvr.callWithRetry(function() -- Line 505
				--[[ Upvalues[2]:
