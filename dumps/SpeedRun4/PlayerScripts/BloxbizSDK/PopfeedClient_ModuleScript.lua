...
local var33_upvw
local tbl_4_upvr = {}
function tbl_14_upvr.isFeedTypeHomeFeed(arg1) -- Line 135
	--[[ Upvalues[1]:
		[1]: tbl_14_upvr (readonly)
	]]
	if not tbl_14_upvr.Config then
	else
		for _, var36 in tbl_14_upvr.Config.feeds.main do
...
function tbl_14_upvr.getUserInfoFromUserIds(arg1) -- Line 147
	--[[ Upvalues[2]:
		[1]: tbl_14_upvr (readonly)
	...
	for _, v in arg1, nil, var52 do
		if tbl_14_upvr.cachedUserInfos[v] then
			module_2[v] = tbl_14_upvr.cachedUserInfos[v]
		else
			table.insert(tbl_6_upvr, v)
		end
	end
	local pcall_result1, pcall_result2 = pcall(function() -- Line 159
		...
		return UserService_upvr:GetUserInfosByUserIdsAsync(tbl_6_upvr)
	end)
	...
	for _, v_2 in tbl_6_upvr do
		...
		tbl_14_upvr.cachedUserInfos[v_2] = var56
		module_2[v_2] = var56
	end
	return module_2
end
function tbl_14_upvr.isProfileFeed(arg1) -- Line 182
	--[[ Upvalues[1]:
		[1]: tbl_14_upvr (readonly)
	]]
	for _, v_4 in tbl_14_upvr.ProfileFeeds do
		if arg1 == v_4.id then
			return true
		end
	end
end
function tbl_14_upvr.getLocalPlayerProfileData() -- Line 190
	--[[ Upvalues[3]:
		[1]: tbl_14_upvr (readonly)
		[2]: LocalPlayer_upvr (readonly)
		[3]: var19_upvw (read and write)
	]]
	tbl_14_upvr.IsLoading:set(true)
	local any_InvokeServer_result1_3, any_InvokeServer_result2_2 = var19_upvw:InvokeServer({
		FeedType = "player";
		NewPageNum = 0;
		ProfileId = LocalPlayer_upvr.UserId;
	})
	tbl_14_upvr.LastLocalPlayerProfileData:set(any_InvokeServer_result2_2.ProfileData)
	tbl_14_upvr.IsLoading:set(false)
	return any_InvokeServer_result1_3, any_InvokeServer_result2_2
end
local tbl_5_upvw = {}
local function _(arg1) -- Line 221, Named "isFetchingThisRequest"
	...
	if not tbl_14_upvr.ContentFetchDebounce:get() then
		return false
	end
	if arg1.IsScrolling then
		local IsScrolling_2 = tbl_5_upvw.IsScrolling
		if IsScrolling_2 then
			if arg1.FeedType ~= tbl_5_upvw.FeedType then
				IsScrolling_2 = false
			else
				IsScrolling_2 = true
			end
...
local function _(arg1) -- Line 231, Named "showLoadingState"
	...
	tbl_14_upvr.IsLoading:set(var65)
end
local function _(arg1) -- Line 235, Named "isLatestRequest"
	...
	local var66
	if tbl_5_upvw.RequestId ~= arg1.RequestId then
		var66 = false
	else
		var66 = true
	end
...
local function requestContent_upvr(arg1) -- Line 239, Named "requestContent"
	...
	if not tbl_14_upvr.ContentFetchDebounce:get() then
		var67 = false
	elseif arg1.IsScrolling and tbl_5_upvw.IsScrolling then
		if arg1.FeedType ~= tbl_5_upvw.FeedType then
			var67 = false
		else
			var67 = true
	...
	tbl_5_upvw = arg1
	var67 = tbl_14_upvr.ContentFetchDebounce:set
	var67(true)
	var67 = tbl_14_upvr.FetchingFeedTypeValue:set
	var67(arg1.FeedType)
	var67 = var19_upvw:InvokeServer(arg1)
	local any_InvokeServer_result1_6, any_InvokeServer_result2 = var19_upvw:InvokeServer(arg1)
	if tbl_5_upvw.RequestId ~= any_InvokeServer_result2.RequestData.RequestId then
	else
	end
...
local function renderLeaderboard_upvr(arg1, arg2, arg3) -- Line 268, Named "renderLeaderboard"
	...
	local function INLINED() -- Internal function, doesn't exist in bytecode
		var79 = tbl_14_upvr.ExplorePageContent[arg3]:get()
		return var79
	end
	...
	tbl_14_upvr.getUserInfoFromUserIds(var81)
	tbl_14_upvr.ExplorePageContent[arg3]:set(var79)
end
local function renderExplorePage_upvr(arg1, arg2) -- Line 285, Named "renderExplorePage"
	...
	local requestContent_upvr_result1_3 = requestContent_upvr(tbl)
	if not requestContent_upvr_result1_3 then
		tbl_14_upvr.IsLoading:set(false)
		return
	end
	if arg2 then
		renderLeaderboard_upvr(requestContent_upvr_result1_3, arg1, arg2)
	else
		for var83 in requestContent_upvr_result1_3 do
			renderLeaderboard_upvr(requestContent_upvr_result1_3, arg1, var83)
		end
	end
	tbl_14_upvr.CurrentPage = nil
	tbl_14_upvr.CurrentPosts = nil
	tbl_14_upvr.CurrentFeedType = "explore"
	tbl_14_upvr.CurrentFeedTypeValue:set("explore")
	tbl_14_upvr.ContentToRender:set({})
	tbl_14_upvr.PostsForImpressionCheck = {}
	task.defer(function() -- Line 314
		--[[ Upvalues[1]:
			[1]: tbl_14_upvr (copied, readonly)
		]]
		local any_get_result1_4 = tbl_14_upvr.ExploreTabScrollingFrame:get()
...
local function renderDonationItems_upvr() -- Line 348, Named "renderDonationItems"
	...
	tbl_14_upvr.IsLoading:set(true)
	local any_get_result1_7 = tbl_14_upvr.CurrentViewingProfileId:get()
	tbl_14_upvr.CurrentPage = 1
	tbl_14_upvr.CurrentPosts = {}
	local var90 = tbl_14_upvr
	...
	tbl_14_upvr.RenderPosts:Fire(var90)
end
local function renderPosts_upvr(arg1, arg2, arg3, arg4, arg5) -- Line 362, Named "renderPosts"
	...
	if arg2 == "shop" and arg3 then
		...
		local any_get_result1_9 = tbl_14_upvr.CurrentViewingProfileId:get()
		if arg5 ~= true or not any_get_result1_9 then
			local var104
		end
		if not var104 then
		end
		local tbl_7 = {}
		tbl_7.FeedType = arg2
		tbl_7.NewPageNum = arg1
		tbl_7.OldPageNum = tbl_14_upvr.CurrentPage
		tbl_7.PostId = any_get_result1_9
		tbl_7.ProfileId = var104
		tbl_7.IsScrolling = arg3
		local requestContent_upvr_result1_2, requestContent_upvr_result2 = requestContent_upvr(tbl_7)
		if requestContent_upvr_result1_2 then
			if arg2 == "notifications" then
				tbl_14_upvr.NotificationCount:set(0)
				if var22_upvw then
					var22_upvw:clearNotices()
				end
			end
			if arg2 ~= "replies" then
				tbl_14_upvr.PostingCommentParent:set(nil)
			end
			...
			if true then
				...
				local any_get_result1_2 = tbl_14_upvr.CurrentProfileData:get()
				tbl_14_upvr.CurrentProfileData:set(requestContent_upvr_result2.ProfileData)
				if any_get_result1_9 == LocalPlayer_upvr.UserId then
					tbl_14_upvr.LastLocalPlayerProfileData:set(ProfileData)
				end
				local LastLoadedProfileTab = tbl_14_upvr.LastLoadedProfileTab
				...
				if var112 then
					if LastLoadedProfileTab == string.match(tbl_14_upvr.Config.profile_tab_order[1], ":[%s]*(.-)[%s]*$") then
					else
					end
				end
				if var111 and true then
					tbl_14_upvr.ContentFetchDebounce:set(nil)
					tbl_14_upvr.OnSwitchFeedClicked(LastLoadedProfileTab, var104)
					return
				end
				tbl_14_upvr.LastLoadedProfileTab = arg2
			end
			tbl_14_upvr.CurrentPage = arg1
			tbl_14_upvr.CurrentPosts = requestContent_upvr_result1_2
			tbl_14_upvr.CurrentFeedType = arg2
			tbl_14_upvr.RenderPosts:Fire(requestContent_upvr_result2, arg4)
			return
		end
...
local function onCanvasPositionChanged_upvr(arg1, arg2) -- Line 454, Named "onCanvasPositionChanged"
	...
	local CurrentPage = tbl_14_upvr.CurrentPage
	local CurrentFeedType = tbl_14_upvr.CurrentFeedType
...
local function loadProfileFeedsConfig_upvr() -- Line 481, Named "loadProfileFeedsConfig"
	...
	local tbl_10 = {}
	for _, v_6 in tbl_14_upvr.Config.feeds.profile do
		table.insert(tbl_10, v_6)
	end
	table.insert(tbl_10, {
		id = "shop";
		name = "Shop";
	...
	tbl_14_upvr.ProfileFeeds = tbl_10
	tbl_14_upvr.initialProfileFeed = string.match(tbl_14_upvr.Config.profile_tab_order[1], ":[%s]*(.-)[%s]*$")
end
local tbl_12_upvw = {}
	...
	if arg1 == true then
		...
		for _, v_7 in IconController_upvr.getIcons(), nil do
			if v_7.name ~= "Popfeed" and v_7.enabled == true then
				...
				table.insert(tbl_12_upvw, v_7)
			end
		end
	else
		for _, var127 in tbl_12_upvw do
...
local function togglePopfeedVisibility_upvr(arg1, arg2) -- Line 526, Named "togglePopfeedVisibility"
	...
	local IsOpened = tbl_14_upvr.IsOpened
	if arg1 == nil then
	...
	if IsOpened:get() == true then
		...
		tbl_14_upvr.LastBottomBtnPress:set("home")
		tbl_14_upvr.IsPosting:set(false)
		var22_upvw:select()
		StarterGui_upvr:SetCore("ChatActive", false)
		if not arg2 then
			renderPosts_upvr(1, var32_upvw or tbl_14_upvr.Config.feeds.main[1].id)
			-- KONSTANTWARNING: GOTO [168] #125
		end
	else
		for _ = 1, tbl_14_upvr.NotificationCount:get() do
			if var22_upvw then
				var22_upvw:notify()
			end
		end
		tbl_14_upvr.ChangeOutfit:FireServer()
		tbl_14_upvr.IsOptions:set(false)
	end
...
function module_upvr.OpenPopfeed() -- Line 583
	...
	if tbl_14_upvr.IsOpened:get() == true then
	else
...
function module_upvr.ClosePopfeed() -- Line 592
	...
	if not tbl_14_upvr.IsOpened:get() then
	else
...
local function setupTopbarButton_upvr() -- Line 609, Named "setupTopbarButton"
	...
	tbl_14_upvr.TopbarButton = var22_upvw
...
local function onPostButtonClicked_upvr(arg1, arg2) -- Line 634, Named "onPostButtonClicked"
	...
	local any_get_result1_5 = tbl_14_upvr.PostingContent:get()
	if not any_get_result1_5 then
		...
		local any_get_result1_8 = tbl_14_upvr.ScreenshotData:get()
		print("Size:", string.format("%.2f", #HttpService_upvr:JSONEncode(any_get_result1_8) / 1000).." KB")
		if var14_upvw:InvokeServer(any_get_result1_5, arg1, tbl_14_upvr.PostingCommentParent:get(), var134, any_get_result1_8) and tbl_14_upvr.CurrentPage == 1 then
			renderPosts_upvr(1, tbl_14_upvr.CurrentFeedType)
		end
		tbl_14_upvr.IsPosting:set(false)
		tbl_14_upvr.PostingContent:set(nil)
		var29_upvw = nil
	end
end
local function onCommentButtonClicked_upvr() -- Line 676, Named "onCommentButtonClicked"
	...
	tbl_14_upvr.IsPosting:set(true)
end
...
local function calculateCanvasOffset_upvr() -- Line 688, Named "calculateCanvasOffset"
	...
	var143 = tbl_14_upvr.ContentFrame:get()
	if not var143 then return end
	var143 = {}
	if tbl_14_upvr.ResetLastViewedPost == true then
		var143 = nil
		tbl_14_upvr.ResetLastViewedPost = nil
		return
	end
	for _, v_8 in tbl_14_upvr.PostFrames do
		if tbl_14_upvr.ScrollingFrame:get().CanvasPosition.Y <= (0) + (v_8.AbsoluteSize.Y + tbl_14_upvr.ContentFrame:get().AbsoluteSize.Y * tbl_14_upvr.UIListLayout:get().Padding.Scale) then
			var143 = {
				Id = v_8.Name;
...
local function onBackButtonClicked_upvr() -- Line 730, Named "onBackButtonClicked"
	...
	local var145 = tbl_14_upvr.undoTable[#tbl_14_upvr.undoTable]
	if not var145 then
	else
		tbl_14_upvr.CurrentViewingProfileId:set(var145.ProfileId)
		tbl_14_upvr.LastBottomBtnPress:set(var145.ActiveBottomBtn)
		if type(tbl_14_upvr.CurrentViewingProfileId:get()) == "string" then
			tbl_14_upvr.PostingCommentParent:set(tbl_14_upvr.CurrentViewingProfileId:get())
		end
		tbl_14_upvr.undoTable[#tbl_14_upvr.undoTable] = nil
		renderPosts_upvr(var145.PageNum, var145.FeedType, false, var145, tbl_14_upvr.isProfileFeed(var145.FeedType))
	end
end
local function onSwitchFeedClicked_upvr(arg1, arg2, arg3) -- Line 749, Named "onSwitchFeedClicked"
	...
	-- KONSTANTWARNING: Variable analysis failed. Output will have some incorrect variable assignments
	tbl_14_upvr.UserSearchFailed:set(false)
	tbl_14_upvr.UserListVisible:set(false)
	local var146
	if var146 == "home" then
		local var147 = var32_upvw
		if not var147 then
			var147 = tbl_14_upvr.Config.feeds.main[1].id
		end
		var146 = var147
	end
	if not not tbl_14_upvr.isProfileFeed(var146) then
		if arg2 == tbl_14_upvr.CurrentViewingProfileId:get() then
		else
		end
	end
	if arg3 then
		tbl_14_upvr.undoTable = {}
	elseif true and tbl_14_upvr.CurrentFeedType then
		table.insert(tbl_14_upvr.undoTable, {
			PageNum = tbl_14_upvr.CurrentPage;
			FeedType = tbl_14_upvr.CurrentFeedType;
			LastViewedPost = calculateCanvasOffset_upvr();
			ProfileId = tbl_14_upvr.CurrentViewingProfileId:get();
			ActiveBottomBtn = tbl_14_upvr.LastBottomBtnPress:get();
		})
	end
	tbl_14_upvr.CurrentViewingProfileId:set(arg2)
	if tbl_14_upvr.CurrentFeedType then
		tbl_14_upvr.LastViewedPage[tbl_14_upvr.CurrentFeedType] = tbl_14_upvr.CurrentPage
	end
	local var149 = 1
	if var146 == tbl_14_upvr.CurrentFeedType then
		var149 = 1
		tbl_14_upvr.ResetLastViewedPost = true
	else
		var149 = tbl_14_upvr.LastViewedPage[var146] or 1
	end
	if tbl_14_upvr.isFeedTypeHomeFeed(var146) then
		var32_upvw = var146
	end
	local var150 = arg2
	if var150 then
	...
	renderPosts_upvr(var149, var146, false, nil, tbl_14_upvr.isProfileFeed(var146) and var150)
end
...
local function onBoostButtonClicked_upvr() -- Line 841, Named "onBoostButtonClicked"
	...
	if var30_upvw then
		...
		var30_upvw = true
		local any_get_result1 = tbl_14_upvr.BoostingPostId:get()
...
local function onImagesButtonClicked_upvr(arg1, arg2, arg3) -- Line 870, Named "onImagesButtonClicked"
	...
	if not searchFromAssetId_upvr_result1 then
		...
		local any_InvokeServer_result1_5, any_InvokeServer_result2_6 = var17_upvw:InvokeServer(arg1, arg2)
		searchFromAssetId_upvr_result1 = any_InvokeServer_result1_5
		local var163 = any_InvokeServer_result2_6
	end
	if searchFromAssetId_upvr_result1 then
		...
		if #searchFromAssetId_upvr_result1 == 0 then
			if arg2 == 1 then
				tbl_14_upvr.Images:set({})
			end
			tbl_14_upvr.IsLoading:set(false)
			return true
		end
		tbl_14_upvr.ImagesPage = arg2
		tbl_14_upvr.ImagesLoadedKeyword = arg1
		local var164
		if tbl_14_upvr.ImagesLoadedKeyword == arg1 and tbl_14_upvr.ImagesPage ~= arg2 then
			var164 = tbl_14_upvr.Images:get()
		...
		tbl_14_upvr.Images:set(var164)
		local any_get_result1_11_upvr = tbl_14_upvr.ImageScrollingFrame:get()
		if any_get_result1_11_upvr then
			...
			task.defer(function() -- Line 921
				...
				any_get_result1_11_upvr.CanvasSize = UDim2.fromOffset(0, any_get_result1_11_upvr.Container.UIGridLayout.AbsoluteContentSize.Y)
			end)
		end
	end
	tbl_14_upvr.IsLoading:set(false)
...
local function onDecalsButtonClicked_upvr(arg1, arg2) -- Line 932, Named "onDecalsButtonClicked"
	...
	local any_InvokeServer_result1_2, any_InvokeServer_result2_4 = var18_upvw:InvokeServer(var176)
	if any_InvokeServer_result1_2 then
		if any_InvokeServer_result2_4 ~= tbl_3_upvr.nextPageCursor then return end
		...
		tbl_14_upvr.DecalsNextPageCursor = any_InvokeServer_result1_2.nextPageCursor
		for _, v_10 in data do
			table.insert(tbl_14_upvr.Images:get(), v_10)
			local var181
		end
		tbl_14_upvr.Images:set(var181)
		local any_get_result1_12_upvr = tbl_14_upvr.ImageScrollingFrame:get()
	...
	tbl_14_upvr.IsLoading:set(any_get_result1_12_upvr)
end
local tbl_8_upvr = {}
local function onFollowersButtonClicked_upvr(arg1, arg2, arg3) -- Line 984, Named "onFollowersButtonClicked"
	...
	tbl_8_upvr.Page = arg2
	tbl_8_upvr.UserId = arg1
	local any_InvokeServer_result1, any_InvokeServer_result2_3 = var15_upvw:InvokeServer(arg1, arg2)
	if any_InvokeServer_result1 then
		if any_InvokeServer_result2_3 and any_InvokeServer_result2_3.UserId ~= tbl_8_upvr.UserId then return end
		if #any_InvokeServer_result1 == 0 then
			if arg2 == 1 then
				tbl_14_upvr.UserListLoaded:set({})
			end
			tbl_14_upvr.IsLoading:set(false)
			return true
		end
		tbl_14_upvr.FollowersPage = arg2
		tbl_14_upvr.FollowersLoadedUserId = arg1
		local tbl_9 = {}
		if arg2 == 1 then
			tbl_14_upvr.UserListLoaded:set({})
			local var196
		end
		if tbl_14_upvr.FollowersLoadedUserId == arg1 and tbl_14_upvr.FollowersPage ~= arg2 then
			var196 = tbl_14_upvr.UserListLoaded:get()
		...
		tbl_14_upvr.getUserInfoFromUserIds(tbl_9)
		tbl_14_upvr.UserListLoaded:set(var196)
		local any_get_result1_10_upvr = tbl_14_upvr.UserListScrollingFrame:get()
		if any_get_result1_10_upvr then
			if arg2 == 1 then
				any_get_result1_10_upvr.CanvasPosition = Vector2.zero
			end
			task.defer(function() -- Line 1042
				--[[ Upvalues[1]:
					[1]: any_get_result1_10_upvr (readonly)
				]]
				any_get_result1_10_upvr.CanvasSize = UDim2.fromOffset(0, any_get_result1_10_upvr.Container.UIListLayout.AbsoluteContentSize.Y)
			end)
		end
	end
	tbl_14_upvr.IsLoading:set(false)
...
local function onFollowingButtonClicked_upvr(arg1, arg2, arg3) -- Line 1053, Named "onFollowingButtonClicked"
	...
	local any_InvokeServer_result1_4, any_InvokeServer_result2_5 = var16_upvw:InvokeServer(arg1, arg2)
	if any_InvokeServer_result1_4 then
		if any_InvokeServer_result2_5 and any_InvokeServer_result2_5.UserId ~= tbl_upvr_2.UserId then return end
		...
		tbl_14_upvr.FollowingPage = arg2
		tbl_14_upvr.FollowingLoadedUserId = arg1
		local tbl_2 = {}
		if arg2 == 1 then
			tbl_14_upvr.UserListLoaded:set({})
			local var212
		end
		if tbl_14_upvr.FollowingLoadedUserId == arg1 and tbl_14_upvr.FollowingPage ~= arg2 then
			var212 = tbl_14_upvr.UserListLoaded:get()
		...
		tbl_14_upvr.getUserInfoFromUserIds(tbl_2)
		tbl_14_upvr.UserListLoaded:set(var212)
		local any_get_result1_upvr = tbl_14_upvr.UserListScrollingFrame:get()
...
local function loadProfileFromFloatingBanner_upvr(arg1) -- Line 1120, Named "loadProfileFromFloatingBanner"
	...
	if tbl_14_upvr.IsOpened:get() == true then
		...
		tbl_14_upvr.DisableHomeButtons = true
		tbl_14_upvr.UpdateHomeButtons:set(not tbl_14_upvr.UpdateHomeButtons:get())
		tbl_14_upvr.CurrentViewingProfileId:set(nil)
		tbl_14_upvr.TopbarButton:select()
		onSwitchFeedClicked_upvr(tbl_14_upvr.initialProfileFeed, arg1.UserId)
	end
end
local function renderCameraView_upvr() -- Line 1134, Named "renderCameraView"
	...
	return require(Windows_upvr.CameraView)(tbl_14_upvr)
end
local var216_upvw
local function toggleCamera_upvr(arg1) -- Line 1140, Named "toggleCamera"
	...
	if arg1 then
		...
		var216_upvw = GuiLoader_upvr.Load(renderCameraView_upvr, var21_upvw, tbl_14_upvr)
...
local function onScreenshotTaken_upvr(arg1) -- Line 1298, Named "onScreenshotTaken"
	...
	tbl_14_upvr.ScreenshotData:set(arg1)
end
local function renderFeed_upvr() -- Line 1302, Named "renderFeed"
	...
	return require(Windows_upvr.Feed)(tbl_14_upvr)
end
...
function module_upvr.init() -- Line 1306
	...
	tbl_14_upvr.ChangeOutfit = BloxbizRemotes_upvr:WaitForChild("PopfeedChangeOutfit")
	tbl_14_upvr.ToggleCamera = toggleCamera_upvr
	tbl_14_upvr.OnScreenshotTaken = onScreenshotTaken_upvr
	tbl_14_upvr.OnSwitchFeedClicked = onSwitchFeedClicked_upvr
	tbl_14_upvr.OnLikeButtonClicked = onLikeButtonClicked_upvr
	tbl_14_upvr.OnPostButtonClicked = onPostButtonClicked_upvr
	tbl_14_upvr.OnBackButtonClicked = onBackButtonClicked_upvr
	tbl_14_upvr.RequestDonationItems = requestDonationItems_upvr
	tbl_14_upvr.OnBoostButtonClicked = onBoostButtonClicked_upvr
	tbl_14_upvr.GetUserProfilePicture = getUserProfilePicture_upvr
	tbl_14_upvr.OnFollowButtonClicked = onFollowButtonClicked_upvr
	tbl_14_upvr.OnImagesButtonClicked = onImagesButtonClicked_upvr
	tbl_14_upvr.OnDecalsButtonClicked = onDecalsButtonClicked_upvr
	tbl_14_upvr.OnCommentButtonClicked = onCommentButtonClicked_upvr
	tbl_14_upvr.TogglePopfeedVisibility = togglePopfeedVisibility_upvr
	tbl_14_upvr.OnFollowersButtonClicked = onFollowersButtonClicked_upvr
	tbl_14_upvr.OnFollowingButtonClicked = onFollowingButtonClicked_upvr
	tbl_14_upvr.OnDeletePostButtonClicked = onDeletePostButtonClicked_upvr
	tbl_14_upvr.OnReportPostButtonClicked = onReportPostButtonClicked_upvr
	tbl_14_upvr.LoadProfileFromFloatingBanner = loadProfileFromFloatingBanner_upvr
	tbl_14_upvr.GetSerializedCharacters = getSerializedCharacters_upvr
	tbl_14_upvr.GetDeserializedCharacters = getDeserializedCharacters_upvr
	tbl_14_upvr.RenderExplorePage = renderExplorePage_upvr
	tbl_14_upvr.closePopfeed = module_upvr.ClosePopfeed
	tbl_14_upvr.CalculateCanvasOffset = calculateCanvasOffset_upvr
	tbl_14_upvr.OnCanvasPositionChanged = onCanvasPositionChanged_upvr
	tbl_14_upvr.Config = var262_upvw:InvokeServer()
	...
	var263_upvw.OnClientEvent:Connect(function(arg1) -- Line 1367
		...
		tbl_14_upvr.NotificationCount:set(arg1)
		if var22_upvw then
			var22_upvw:clearNotices()
			for _ = 1, arg1 do
				var22_upvw:notify()
	...
	var11_upvw.OnClientEvent:Connect(function(arg1) -- Line 1378
		...
		if arg1 then
			local BoostingPostBoostValue_2 = tbl_14_upvr.BoostingPostBoostValue
			if BoostingPostBoostValue_2 then
				BoostingPostBoostValue_2:set(BoostingPostBoostValue_2:get() + 1)
			end
		end
		tbl_14_upvr.IsBoosting:set(false)
		var30_upvw = nil
	end)
	var264_upvw.OnClientEvent:Connect(function(arg1) -- Line 1390
		...
		tbl_14_upvr.ImageSearchTerms:set(var282)
	end)
	...
	CurrentCamera_upvr:GetPropertyChangedSignal("ViewportSize"):Connect(function() -- Line 1400, Named "setVertical"
		...
		if CurrentCamera_upvr.ViewportSize.X < CurrentCamera_upvr.ViewportSize.Y then
			tbl_14_upvr.IsVertical:set(true)
		else
			tbl_14_upvr.IsVertical:set(false)
		end
	end)
	if CurrentCamera_upvr.ViewportSize.X < CurrentCamera_upvr.ViewportSize.Y then
		tbl_14_upvr.IsVertical:set(true)
	...
	if any_read_result1_upvr then
		local function onCharacterAdded_upvr(arg1, arg2) -- Line 1412, Named "onCharacterAdded"
			...
			local tbl_13_upvr = {}
			tbl_13_upvr.Player = arg2
			tbl_13_upvr.RootPart = HumanoidRootPart
			tbl_13_upvr.FeedProps = tbl_14_upvr
			...
			local any_Load_result1_upvr = GuiLoader_upvr.Load(function() -- Line 1438
				...
				return require(Windows_upvr.FloatingProfile)(tbl_13_upvr)
			end, var21_upvw, tbl_13_upvr)
	...
	onCharacterAdded_upvr(function() -- Line 1472
		...
		while task.wait(60) do
			local PostImpressions = tbl_14_upvr.PostImpressions
			if #PostImpressions ~= 0 then
				var265_upvw:FireServer(PostImpressions)
				tbl_14_upvr.PostImpressions = {}
			end
		end
	end)
	...
	onCharacterAdded_upvr(renderFeed_upvr, var21_upvw, tbl_14_upvr)
end
return module_upvr