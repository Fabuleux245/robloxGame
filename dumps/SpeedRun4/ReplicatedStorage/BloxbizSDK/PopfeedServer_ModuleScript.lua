...
-- Decompiled on 2025-07-21 11:08:39
-- Luau version 6, Types version 3
-- Time taken: 0.028936 seconds
...
local function processBoostPost_upvr(arg1, arg2, arg3) -- Line 117, Named "processBoostPost"
	...
	local pcall_result1_19, pcall_result2_10 = pcall(function() -- Line 131
		--[[ Upvalues[6]:
	...
	if not pcall_result1_19 then
		warn("Boosting a post failed!", pcall_result2_10)
		return
	end
...
local function fetchBoostPasses_upvr(arg1, arg2) -- Line 153, Named "fetchBoostPasses"
	...
	local pcall_result1_7, pcall_result2_18 = pcall(function() -- Line 163
		...
		return HttpService_upvr:PostAsync(any_getNewUrl_result1_upvw_21, HttpService_upvr:JSONEncode(any_getGameStats_result1_upvr_8), nil, nil, BatchHTTP_upvr.getGeneralRequestHeaders())
	end)
...
local function fetchConfig_upvr() -- Line 183, Named "fetchConfig"
	...
	local pcall_result1_10, pcall_result2_11 = pcall(function() -- Line 193
		--[[ Upvalues[4]:
			[1]: HttpService_upvr (copied, readonly)
		...
		return HttpService_upvr:PostAsync(any_getNewUrl_result1_upvw_12, HttpService_upvr:JSONEncode(any_getGameStats_result1_upvr_9), nil, nil, BatchHTTP_upvr.getGeneralRequestHeaders())
	end)
	if not pcall_result1_10 then
		warn("Fetching popfeed config failed!", pcall_result2_11)
		return
	end
...
local function fetchProfile_upvr(arg1, arg2) -- Line 256, Named "fetchProfile"
	...
	local pcall_result1_9, pcall_result2_13 = pcall(function() -- Line 269
		--[[ Upvalues[6]:
			[1]: HttpService_upvr (copied, readonly)
	...
	if not pcall_result1_9 then
		warn("Fetching profile data failed!", pcall_result2_13)
		return
	end
	local any_JSONDecode_result1_5 = HttpService_upvr:JSONDecode(pcall_result2_13)
...
local function fetchPlayerDecals_upvr(arg1, arg2) -- Line 327, Named "fetchPlayerDecals"
	...
	local pcall_result1_12, pcall_result2_12 = pcall(function() -- Line 345
		--[[ Upvalues[6]:
			[1]: HttpService_upvr (copied, readonly)
	...
	if not pcall_result1_12 then
		warn("Fetching player's decals failed!", pcall_result2_12)
		return
	end
	return HttpService_upvr:JSONDecode(pcall_result2_12)
end
local function fetchImages_upvr(arg1, arg2) -- Line 365, Named "fetchImages"
	...
	local pcall_result1_11, pcall_result2_21 = pcall(function() -- Line 379
		--[[ Upvalues[6]:
			[1]: HttpService_upvr (copied, readonly)
		...
		return HttpService_upvr:PostAsync(any_getNewUrl_result1_upvw_18, HttpService_upvr:JSONEncode(merge_upvr(module_25_upvr, any_getGameStats_result1_upvr_12)), nil, nil, BatchHTTP_upvr.getGeneralRequestHeaders())
	end)
...
local function fetchDefaultImageTerms_upvr(arg1) -- Line 399, Named "fetchDefaultImageTerms"
	...
	local function var99() -- Line 412
		...
		return HttpService_upvr:PostAsync(any_getNewUrl_result1_upvw_3, HttpService_upvr:JSONEncode(merge_upvr(module_28_upvr, any_getGameStats_result1_upvr_13)), nil, nil, BatchHTTP_upvr.getGeneralRequestHeaders())
	end
	var98 = var98(var99)
...
local function fetchFollowersList_upvr(arg1, arg2, arg3) -- Line 466, Named "fetchFollowersList"
	...
	local pcall_result1_4, pcall_result2_16 = pcall(function() -- Line 480
		--[[ Upvalues[6]:
			[1]: HttpService_upvr (copied, readonly)
		...
		return HttpService_upvr:PostAsync(any_getNewUrl_result1_upvw_10, HttpService_upvr:JSONEncode(merge_upvr(module_18_upvr, any_getGameStats_result1_upvr_14)), nil, nil, BatchHTTP_upvr.getGeneralRequestHeaders())
	end)
	if not pcall_result1_4 then
		warn("Fetching followers list failed!", pcall_result2_16)
		return
	end
	return HttpService_upvr:JSONDecode(pcall_result2_16)
end
local function readNotifications_upvr(arg1, arg2) -- Line 500, Named "readNotifications"
	...
	local pcall_result1_17, pcall_result2_22 = pcall(function() -- Line 515
		--[[ Upvalues[6]:
			[1]: HttpService_upvr (copied, readonly)
...
local function fetchNotificationCounts_upvr(arg1) -- Line 535, Named "fetchNotificationCounts"
	...
	local pcall_result1_16, pcall_result2_2 = pcall(function() -- Line 549
		--[[ Upvalues[6]:
			[1]: HttpService_upvr (copied, readonly)
		...
		return HttpService_upvr:PostAsync(any_getNewUrl_result1_upvw_9, HttpService_upvr:JSONEncode(merge_upvr(module_17_upvr, any_getGameStats_result1_upvr_19)), nil, nil, BatchHTTP_upvr.getGeneralRequestHeaders())
	end)
...
local function fetchNotifications_upvr(arg1, arg2) -- Line 571, Named "fetchNotifications"
	...
	if arg2 < 1 then
		...
		local pcall_result1_20, pcall_result2_9 = pcall(function() -- Line 590
			--[[ Upvalues[6]:
				[1]: HttpService_upvr (copied, readonly)
		...
		if not pcall_result1_20 then
			warn("Fetching notifications data failed!", pcall_result2_9)
			return
		end
		local any_JSONDecode_result1_2 = HttpService_upvr:JSONDecode(pcall_result2_9)
...
local function fetchLeaderboards_upvr(arg1) -- Line 616, Named "fetchLeaderboards"
	...
	local pcall_result1_21, pcall_result2_17 = pcall(function() -- Line 629
		--[[ Upvalues[6]:
			[1]: HttpService_upvr (copied, readonly)
	...
	if not pcall_result1_21 then
		warn("Fetching leaderboards data failed!", pcall_result2_17)
	else
		for i_13 in tbl_upvw.Pages do
			for _, v_12 in HttpService_upvr:JSONDecode(pcall_result2_17)[i_13] do
...
local function fetchFeed_upvr(arg1, arg2, arg3, arg4) -- Line 743, Named "fetchFeed"
	...
	if arg2 < var173 then
		...
		local pcall_result1_15, pcall_result2_4 = pcall(function() -- Line 766
			--[[ Upvalues[6]:
				[1]: HttpService_upvr (copied, readonly)
...
local function onPostContentResponse_upvr(arg1, arg2, arg3, arg4, arg5, arg6) -- Line 930, Named "onPostContentResponse"
	...
	local pcall_result1_14, pcall_result2_19 = pcall(function() -- Line 931
		--[[ Upvalues[3]:
	...
	local function var234() -- Line 974
		...
		return HttpService_upvr:PostAsync(any_getNewUrl_result1_upvw_8, HttpService_upvr:JSONEncode(merge_upvr(module_12_upvr, any_getGameStats_result1_upvr_18)), nil, nil, BatchHTTP_upvr.getGeneralRequestHeaders())
	end
...
local function sendImpressions_upvr() -- Line 992, Named "sendImpressions"
	...
	local pcall_result1_18, pcall_result2_14 = pcall(function() -- Line 1005
		--[[ Upvalues[6]:
			[1]: HttpService_upvr (copied, readonly)
		...
		return HttpService_upvr:PostAsync(any_getNewUrl_result1_upvw_2, HttpService_upvr:JSONEncode(merge_upvr(module_22_upvr, any_getGameStats_result1_upvr_15)), nil, nil, BatchHTTP_upvr.getGeneralRequestHeaders())
	end)
	if not pcall_result1_18 then
		warn("Sending impressions to backend failed!", pcall_result2_14)
	else
		tbl_4_upvw = {}
	end
end
local function likePost_upvr(arg1, arg2, arg3) -- Line 1023, Named "likePost"
	...
	local pcall_result1_5, pcall_result2 = pcall(function() -- Line 1037
		...
		return HttpService_upvr:PostAsync(any_getNewUrl_result1_upvw_13, HttpService_upvr:JSONEncode(merge_upvr(module_3_upvr, any_getGameStats_result1_upvr_17)), nil, nil, BatchHTTP_upvr.getGeneralRequestHeaders())
	end)
...
local function followUser_upvr(arg1, arg2, arg3) -- Line 1053, Named "followUser"
	...
	local pcall_result1_8, pcall_result2_3 = pcall(function() -- Line 1069
		...
		return HttpService_upvr:PostAsync(any_getNewUrl_result1_upvw_11, HttpService_upvr:JSONEncode(merge_upvr(module_21_upvr, any_getGameStats_result1_upvr_16)), nil, nil, BatchHTTP_upvr.getGeneralRequestHeaders())
	end)
...
local function reportPost_upvr(arg1, arg2) -- Line 1146, Named "reportPost"
	...
	if type(arg2) ~= "string" then
		...
		local pcall_result1_13, pcall_result2_15 = pcall(function() -- Line 1164
			--[[ Upvalues[6]:
				[1]: HttpService_upvr (copied, readonly)
		...
		if not pcall_result1_13 then
			warn("Reporting post failed!", pcall_result2_15)
			return
		end
	end
end
...
local function _(arg1) -- Line 1182, Named "cacheRealOutfit"
	...
	if not Character_2 then
		...
		tbl_6_upvr[arg1] = Humanoid_3:GetAppliedDescription()
	end
end
		...
		if arg2 then
			...
			if not Character_3 then
				...
				if not Humanoid_2 then
					...
					tbl_6_upvr[arg1] = Humanoid_2:GetAppliedDescription()
				end
			end
			tbl_9_upvr[arg1] = tick()
			return
		end
		local var278 = not arg2
		if var278 then
			if tbl_9_upvr[arg1] ~= nil then
				var278 = false
			else
				var278 = true
			end
		...
		if not arg2 then
			...
			table.insert(BatchHTTP_upvr.eventQueue, {
				...
				data = merge_upvr(merge_upvr({
					time_spent = tick() - tbl_9_upvr[arg1];
					timestamp = os.time();
...
local function onSearchImagesResponse_upvr(arg1, arg2, arg3) -- Line 1336, Named "onSearchImagesResponse"
	...
	local var302 = tbl_upvw_2[arg2..arg3]
	if not var302 then
		var302 = fetchImages_upvr(arg2, arg3)
		tbl_upvw_2[arg2..arg3] = var302
	end
	local module_14 = {}
...
local function requestSearchTerms_upvr(arg1) -- Line 1370, Named "requestSearchTerms"
	...
	var10_upvw:FireClient(arg1, tbl_2_upvw)
end
...
function module_20_upvr.init() -- Line 1381
	--[[ Upvalues[58]:
		...
		[51]: tbl_2_upvw (read and write)
		[52]: tbl_upvw_2 (read and write)
		[53]: tbl_upvw (read and write)
		[54]: tbl_4_upvw (read and write)
		...
		if not Character then
			...
			if not arg2 then
				if tbl_6_upvr[arg1] then
					Humanoid:ApplyDescription(tbl_6_upvr[arg1])
				end
				return
			end
			local SOME = ReplicatedStorage_upvr.Outfits:FindFirstChild(arg2)
			if not SOME then return end
			SOME.Face = tbl_6_upvr[arg1].Face
			SOME.Head = tbl_6_upvr[arg1].Head
			SOME.HeadScale = tbl_6_upvr[arg1].HeadScale
			SOME.HeadColor = tbl_6_upvr[arg1].HeadColor
			SOME.HatAccessory = tbl_6_upvr[arg1].HatAccessory
			SOME.FaceAccessory = tbl_6_upvr[arg1].FaceAccessory
			SOME.HairAccessory = tbl_6_upvr[arg1].HairAccessory
	...
	Players_upvr.PlayerRemoving:Connect(function(arg1) -- Line 1510
		...
		local table_find_result1 = table.find(tbl_7_upvr, arg1.UserId)
		if table_find_result1 then
			table.remove(tbl_7_upvr, table_find_result1)
		end
		tbl_6_upvr[arg1] = nil
		tbl_upvr[arg1] = nil
		tbl_upvr_3[arg1] = nil
	...
	Players_upvr.PlayerAdded:Connect(function(arg1) -- Line 1524
		...
		tbl_upvr[arg1] = {}
		tbl_upvr_3[arg1] = {}
		table.insert(tbl_7_upvr, arg1.UserId)
	...
	task.spawn(function() -- Line 1542
		...
		while true do
			...
			if fetchDefaultImageTerms_result1 then
				...
				table.insert(tbl_2_upvw, top_terms[1])
				table.insert(tbl_2_upvw, top_terms[2])
				table.insert(tbl_2_upvw, top_terms[3])
				table.insert(tbl_2_upvw, top_terms[4])
				table.insert(tbl_2_upvw, top_terms[5])
				table.insert(tbl_2_upvw, top_terms[6])
				table.insert(tbl_2_upvw, top_terms[7])
				table.insert(tbl_2_upvw, top_terms[8])
				var10_upvw:FireAllClients(tbl_2_upvw)
			end
			task.wait(120)
		end
	end)
	...
	task.spawn(function() -- Line 1592
		--[[ Upvalues[2]:
			[1]: tbl_4_upvw (copied, read and write)
			[2]: sendImpressions_upvr (copied, readonly)
		]]
		while true do
			task.wait(120)
			if #tbl_4_upvw ~= 0 then
