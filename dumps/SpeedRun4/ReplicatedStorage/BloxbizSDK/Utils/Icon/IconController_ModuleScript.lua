...
-- Decompiled on 2025-07-21 11:07:59
-- Luau version 6, Types version 3
-- Time taken: 0.035172 seconds
...
local function _() -- Line 40, Named "checkTopbarEnabled"
	...
	local xpcall_result1_7, xpcall_result2_2 = xpcall(function() -- Line 41
		--[[ Upvalues[1]:
	...
	return xpcall_result1_7 and xpcall_result2_2
end
local function _() -- Line 50, Named "checkTopbarEnabledAccountingForMimic"
	...
	local xpcall_result1, xpcall_result2_4 = xpcall(function() -- Line 41
		--[[ Upvalues[1]:
			[1]: StarterGui_upvr (copied, readonly)
		]]
		return StarterGui_upvr:GetCore("TopbarEnabled")
	...
	local var28 = xpcall_result1 and xpcall_result2_4
	if not var28 then
...
local xpcall_result1_2, xpcall_result2_7 = xpcall(function() -- Line 41
	--[[ Upvalues[1]:
		[1]: StarterGui_upvr (readonly)
	]]
	return StarterGui_upvr:GetCore("TopbarEnabled")
...
module_2_upvr.previousTopbarEnabled = xpcall_result1_2 and xpcall_result2_7
...
function module_2_upvr.updateTopbar() -- Line 254
	...
	local function getIncrement_upvr(arg1, arg2) -- Line 255, Named "getIncrement"
		...
		if arg1._parentIcon == nil then
			local any_getMenuOffset_result1_2, any_getMenuOffset_result2, any_getMenuOffset_result3 = module_2_upvr.getMenuOffset(arg1)
			var80 += any_getMenuOffset_result1_2
	...
	task.defer(function() -- Line 275
		...
		for i_7, v_7 in pairs(tbl_4_upvr) do
			...
			for _, v_10 in pairs(records) do
				...
				local any_get_result1 = v_10:get("repositionInfo")
				if any_get_result1 then
					TweenService_upvr:Create(v_10.instances.iconContainer, any_get_result1, {
						Position = udim2;
					}):Play()
				else
		...
		local function _(arg1, arg2, arg3) -- Line 333, Named "getBoundaryX"
			...
			local any_getMenuOffset_result1, any_getMenuOffset_result2_4 = module_2_upvr.getMenuOffset(arg1)
			local var172
			local function INLINED() -- Internal function, doesn't exist in bytecode
				var172 = -var169 - any_getMenuOffset_result1
				return var172
			end
		...
		local function _(arg1, arg2) -- Line 342, Named "getSizeX"
			...
			local any_get_result1_3, any_get_result2_2 = arg1:get("iconSize", arg1:getIconState(), "beforeDropdown")
			local any_get_result1_6 = arg1:get("iconSize", "hovering")
			local var182
			if var182 and any_get_result2_2 and any_get_result1_6 then
				var182 = any_get_result1_6.X.Offset
				if any_get_result2_2.X.Offset < var182 then
					any_get_result2_2 = any_get_result1_6
				end
			end
			local function INLINED_3() -- Internal function, doesn't exist in bytecode
				var182 = any_get_result2_2
				return var182
			end
			if not arg2 or not INLINED_3() then
				var182 = any_get_result1_3
			end
		...
		local pairs_result1_7, pairs_result2_4, pairs_result3 = pairs(tbl_4_upvr)
...
function module_2_upvr.setGap(arg1, arg2) -- Line 638
	...
	local var213 = tonumber(arg1) or 12
	...
	if any_lower_result1 == "left" or any_lower_result1 == "mid" or any_lower_result1 == "right" then
		module_2_upvr[any_lower_result1.."Gap"] = var213
		module_2_upvr.updateTopbar()
	else
		module_2_upvr.leftGap = var213
		module_2_upvr.midGap = var213
		module_2_upvr.rightGap = var213
		module_2_upvr.updateTopbar()
	end
end
...
LocalPlayer_upvr.CharacterAdded:Connect(function() -- Line 664
	...
	for _, v_11 in pairs(tbl_2_upvw) do
		v_11:destroy()
	end
	tbl_2_upvw = {}
end)
...
function module_2_upvr._setControllerSelectedObject(arg1) -- Line 720
	...
	local function INLINED_4() -- Internal function, doesn't exist in bytecode
		var229_upvr = module_2_upvr._controllerSetCount + 1
		return var229_upvr
	end
	if not module_2_upvr._controllerSetCount or not INLINED_4() then
		var229_upvr = 0
	end
	module_2_upvr._controllerSetCount = var229_upvr
	...
	task.delay(0.1, function() -- Line 724
		...
		if var229_upvr == module_2_upvr._controllerSetCountS then
			pcall(SetSelectedObject_upvr, arg1)
		end
	end)
end
function module_2_upvr._enableControllerMode(arg1) -- Line 732
	...
	if module_2_upvr.controllerModeEnabled == arg1 then
		...
		if arg1 then
			...
			local xpcall_result1_8, xpcall_result2 = xpcall(function() -- Line 41
				--[[ Upvalues[1]:
					[1]: StarterGui_upvr (copied, readonly)
				]]
				return StarterGui_upvr:GetCore("TopbarEnabled")
			...
			local var241 = xpcall_result1_8 and xpcall_result2
			if not var241 then
				var241 = not module_2_upvr.mimicCoreGui
			end
			Indicator.Visible = var241
			Indicator.Position = UDim2.new(0.5, 0, 0, 5)
			Indicator.Active = true
			var18_upvw = Indicator.InputBegan:Connect(function(arg1_5) -- Line 749
				--[[ Upvalues[1]:
					[1]: module_2_upvr (copied, readonly)
				]]
			...
			local xpcall_result1_6, xpcall_result2_9 = xpcall(function() -- Line 41
				--[[ Upvalues[1]:
					[1]: StarterGui_upvr (copied, readonly)
				]]
				return StarterGui_upvr:GetCore("TopbarEnabled")
			end, function(arg1_6) -- Line 43
				return true
			end)
			local var247 = xpcall_result1_6 and xpcall_result2_9
			if not var247 then
				var247 = not module_2_upvr.mimicCoreGui
			end
			TopbarPlusGui_upvr.TopbarContainer.Visible = var247
	...
	if var251_upvw then
		...
		task.defer(function() -- Line 810
			...
			require(Parent_upvr).new():setProperty("internalIcon", true):setName("_FakeHealthbar"):setRight():setOrder(-420):setSize(80, 32):lock():set("iconBackgroundTransparency", 1):give(function(arg1) -- Line 822
				...
				clone_upvr.Name = "HealthBar"
				clone_upvr.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				clone_upvr.BorderSizePixel = 0
				clone_upvr.AnchorPoint = Vector2.new(0, 0.5)
				clone_upvr.Position = UDim2.new(0, 0, 0.5, 0)
				clone_upvr.Size = UDim2.new(0.5, 0, 1, 0)
				clone_upvr.Visible = true
				clone_upvr.ZIndex = 13
				clone_upvr.Parent = clone
				local function powColor3_upvr(arg1_7, arg2) -- Line 865, Named "powColor3"
					return Color3.new(math.pow(arg1_7.R, arg2), math.pow(arg1_7.G, arg2), math.pow(arg1_7.B, arg2))
				end
				local function _(arg1_8, arg2, arg3, arg4) -- Line 873, Named "lerpColor"
					--[[ Upvalues[1]:
						[1]: powColor3_upvr (readonly)
					]]
					local var258 = arg4 or 2
					local var259 = var258
					local var260 = var258
					return powColor3_upvr(Color3.new(math.pow(arg1_8.R, var259), math.pow(arg1_8.G, var259), math.pow(arg1_8.B, var259)):Lerp(Color3.new(math.pow(arg2.R, var260), math.pow(arg2.G, var260), math.pow(arg2.B, var260)), arg3), 1 / var258)
				end
				local var261_upvw = true
				local Color3_fromRGB_result1_upvr_2 = Color3.fromRGB(27, 252, 107)
				local Color3_fromRGB_result1_upvr_3 = Color3.fromRGB(250, 235, 0)
				local Color3_fromRGB_result1_upvr = Color3.fromRGB(255, 28, 0)
				local function listenToHealth_upvr(arg1_9) -- Line 881, Named "listenToHealth"
					--[[ Upvalues[8]:
						[1]: StarterGui_upvr (copied, readonly)
						[2]: module_2_upvr (copied, readonly)
						[3]: var261_upvw (read and write)
						[4]: arg1 (readonly)
					...
					if not arg1_9 then
						...
						local Humanoid_upvr = arg1_9:WaitForChild("Humanoid", 10)
						...
						local function updateHealthBar() -- Line 890
							--[[ Upvalues[9]:
								...
								[7]: Color3_fromRGB_result1_upvr_3 (copied, readonly)
								[8]: Color3_fromRGB_result1_upvr (copied, readonly)
								[9]: clone_upvr (copied, readonly)
							]]
							-- KONSTANTWARNING: Variable analysis failed. Output will have some incorrect variable assignments
							-- KONSTANTERROR: [0] 1. Error Block 53 start (CF ANALYSIS FAILED)
							local var266 = Humanoid_upvr.Health / Humanoid_upvr.MaxHealth
							local var267
							local function INLINED_5() -- Internal function, doesn't exist in bytecode
								var267 = module_2_upvr
								return var267.healthbarDisabled
							end
							if var266 == 1 or INLINED_5() or var261_upvw and StarterGui_upvr:GetCoreGuiEnabled(Enum.CoreGuiType.Health) == false then
								var267 = arg1
								if var267.enabled then
									arg1:setEnabled(false)
								end
							else
								if var266 < 1 then
									var267 = arg1
									if not var267.enabled then
								...
								var267 = 1.25 * var266
								local var268 = var267 + -0.125
								if 1 < var268 then
									var267 = 1
									-- KONSTANTWARNING: GOTO [69] #54
								end
								-- KONSTANTERROR: [0] 1. Error Block 53 end (CF ANALYSIS FAILED)
								-- KONSTANTERROR: [63] 49. Error Block 50 start (CF ANALYSIS FAILED)
								if var268 < 0 then
									var267 = 0
								else
									var267 = var268
								end
								if 0.5 >= var266 or not Color3_fromRGB_result1_upvr_2 then
									local var269 = Color3_fromRGB_result1_upvr_3
								end
								if 0.5 >= var266 or not Color3_fromRGB_result1_upvr_3 then
									local var270 = Color3_fromRGB_result1_upvr
								end
								local var271 = (1 - var267) * 2
								if 0.5 >= var266 or not (1 - var271) then
								end
								local var272 = nil or 2
								local var273 = var272
								local var274 = var272
								local any_Lerp_result1 = Color3.new(math.pow(var270.R, var273), math.pow(var270.G, var273), math.pow(var270.B, var273)):Lerp(Color3.new(math.pow(var269.R, var274), math.pow(var269.G, var274), math.pow(var269.B, var274)), 2 - var271)
								local var276 = 1 / var272
								clone_upvr.BackgroundColor3 = Color3.new(math.pow(any_Lerp_result1.R, var276), math.pow(any_Lerp_result1.G, var276), math.pow(any_Lerp_result1.B, var276))
								clone_upvr.Size = UDim2.new(var266, 0, 1, 0)
								-- KONSTANTERROR: [63] 49. Error Block 50 end (CF ANALYSIS FAILED)
							end
						end
				...
				LocalPlayer_upvr.CharacterAdded:Connect(function(arg1_10) -- Line 927
					--[[ Upvalues[1]:
						[1]: listenToHealth_upvr (readonly)
					]]
					listenToHealth_upvr(arg1_10)
				end)
...
function module_2_upvr._determineControllerDisplay() -- Line 935
	...
	local MouseEnabled_2 = UserInputService_upvr.MouseEnabled
	...
	if MouseEnabled_2 and GamepadEnabled then
...
coroutine.wrap(function() -- Line 962
	--[[ Upvalues[12]:
		...
		[11]: var285_upvw (read and write)
		[12]: any_IsStudio_result1_upvr (readonly)
	]]
	RunService_upvr.Heartbeat:Wait()
	local var8_2 = require(Parent_upvr)
	local any_setProperty_result1_upvr = var8_2.new():setProperty("internalIcon", true):setName("_TopbarControllerOption"):setOrder(100):setImage(11162828670):setRight():setEnabled(false):setTip("Controller mode"):setProperty("deselectWhenOtherIconSelected", false)
	...
	local function iconClicked() -- Line 986
		...
		local var327 = any_setProperty_result1_upvr
		local isSelected = var327.isSelected
		if isSelected then
			var327 = "Normal mode"
		else
			var327 = "Controller mode"
		end
		any_setProperty_result1_upvr:setTip(var327)
		module_2_upvr._enableControllerMode(isSelected)
	end
		...
		if not module_2_upvr.controllerModeEnabled then
			...
			if arg1.KeyCode == Enum.KeyCode.DPadDown then
				if not GuiService_upvr.SelectedObject then
					local xpcall_result1_5, xpcall_result2_5 = xpcall(function() -- Line 41
						--[[ Upvalues[1]:
							[1]: StarterGui_upvr (copied, readonly)
						]]
						return StarterGui_upvr:GetCore("TopbarEnabled")
					end, function(arg1_12) -- Line 43
						return true
					end)
					local var334 = xpcall_result1_5 and xpcall_result2_5
					if not var334 then
						var334 = not module_2_upvr.mimicCoreGui
					end
					if var334 then
						module_2_upvr.setTopbarEnabled(true, false)
	...
	for var348, v_12 in pairs(tbl_4_upvr) do
		if var348 ~= "mid" then
			local any_setEnabled_result1_2 = var8_2.new():setProperty("internalIcon", true):setImage(6069276526):setName("_overflowIcon-"..var348):setEnabled(false)
			v_12.overflowIcon = any_setEnabled_result1_2
			any_setEnabled_result1_2.accountForWhenDisabled = true
			if var348 == "left" then
				any_setEnabled_result1_2:setOrder(math.huge)
				any_setEnabled_result1_2:setLeft()
				any_setEnabled_result1_2:set("dropdownAlignment", "right")
			elseif var348 == "right" then
				any_setEnabled_result1_2:setOrder((-math.huge))
				any_setEnabled_result1_2:setRight()
				any_setEnabled_result1_2:set("dropdownAlignment", "left")
			end
			any_setEnabled_result1_2.lockedSettings = {
				iconImage = true;
				order = true;
				alignment = true;
			}
	...
	task.defer(function() -- Line 1049
		--[[ Upvalues[5]:
			...
			[3]: module_2_upvr (copied, readonly)
			[4]: var285_upvw (copied, read and write)
			[5]: any_IsStudio_result1_upvr (copied, readonly)
		]]
		-- KONSTANTWARNING: Variable analysis failed. Output will have some incorrect variable assignments
		local var341_upvw
		while true do
			local pcall_result1, pcall_result2_3 = pcall(function() -- Line 1052
				--[[ Upvalues[2]:
					[1]: VoiceChatService_upvr (copied, readonly)
					[2]: LocalPlayer_upvr (copied, readonly)
				]]
			...
			var341_upvw = pcall_result1
			local var345_upvw = pcall_result2_3
			if var341_upvw then break end
			task.wait(1)
		end
		local function _() -- Line 1058, Named "checkVoiceChatManuallyEnabled"
			--[[ Upvalues[4]:
				[1]: module_2_upvr (copied, readonly)
				[2]: var341_upvw (read and write)
				[3]: var345_upvw (read and write)
				[4]: var285_upvw (copied, read and write)
			]]
			if module_2_upvr.voiceChatEnabled and var341_upvw and var345_upvw then
				var285_upvw = true
				module_2_upvr.updateTopbar()
			end
		end
		...
		task.delay(10, function() -- Line 1070
			...
			if module_2_upvr.voiceChatEnabled == nil and var341_upvw and var345_upvw and any_IsStudio_result1_upvr then
	...
	if not any_IsStudio_result1_upvr then
		...
		var348 = "GroupService"
		var348 = game
		var348 = Enum.CreatorType.Group
		if var348.CreatorType == var348 then
			local service_upvr = game:GetService(var348)
			function var348() -- Line 1088
				--[[ Upvalues[1]:
					[1]: service_upvr (readonly)
				]]
				return service_upvr:GetGroupInfoAsync(game.CreatorId).Owner
			end
			local pcall_result1_4, pcall_result2_2_upvr = pcall(var348)
			if pcall_result1_4 then
				CreatorId = pcall_result2_2_upvr.Id
			end
		end
		v_12 = Parent_upvr
		pcall_result2_2_upvr = v_12.VERSION
		v_12 = LocalPlayer_upvr
		pcall_result2_2_upvr = v_12.UserId
		if pcall_result2_2_upvr ~= CreatorId then
			pcall_result2_2_upvr = game:GetService("MarketplaceService")
			v_12 = pcall
			local function var352() -- Line 1096
				--[[ Upvalues[1]:
					[1]: pcall_result2_2_upvr (readonly)
				]]
				return pcall_result2_2_upvr:GetProductInfo(game.PlaceId)
			end
			v_12 = v_12(var352)
			local v_12_result1, v_12_result2 = v_12(var352)
			if v_12_result1 and v_12_result2 then
				print("\n\n\n⚽ %s uses TopbarPlus-Forked %s\n🍍 TopbarPlus-Forked was originally developed by ForeverHD and the Nanoblox Team, forked by iamEvanRBLX.\n🚀 You can learn more and take a free copy by searching for 'TopbarPlus' on the DevForum\n\n":format(v_12_result2.Name, require(pcall_result2_2_upvr)))
			end
		end
	end
end)()
coroutine.wrap(function() -- Line 1109
	...
	if not ChatScript then
		...
		require(ChatMain).CoreGuiEnabled:connect(function() -- Line 1115
			...
			local xpcall_result1_4, xpcall_result2_3 = xpcall(function() -- Line 41
				--[[ Upvalues[1]:
					[1]: StarterGui_upvr (copied, readonly)
				]]
				return StarterGui_upvr:GetCore("TopbarEnabled")
			...
			local var363 = xpcall_result1_4 and xpcall_result2_3
			if var363 == module_2_upvr.previousTopbarEnabled then
				module_2_upvr.updateTopbar()
				return "SetCoreGuiEnabled was called instead of SetCore"
			end
			if module_2_upvr.mimicCoreGui then
				module_2_upvr.previousTopbarEnabled = var363
				if module_2_upvr.controllerModeEnabled then
					module_2_upvr.setTopbarEnabled(false, false)
				else
					module_2_upvr.setTopbarEnabled(var363, false)
				end
			end
			module_2_upvr.updateTopbar()
		end)
		...
		local var368
		if not var368 and not module_2_upvr.mimicCoreGui then
			var368 = true
		end
		module_2_upvr.setTopbarEnabled(var368, false)
	end
end)()
...
task.spawn(function() -- Line 1159
	...
	local pcall_result1_2, pcall_result2 = pcall(function() -- Line 1160
		--[[ Upvalues[2]:
	...
	if pcall_result1_2 then
		module_2_upvr.translator = pcall_result2
		pcall_result2:GetPropertyChangedSignal("LocaleId"):Connect(updateAllIcons)
