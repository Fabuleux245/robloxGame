...
-- Decompiled on 2025-07-21 11:08:41
...
local function GetProductInfo_upvr(arg1, arg2) -- Line 53, Named "GetProductInfo"
	...
	local module = {}
	local pcall_result1_3, pcall_result2_6 = pcall(function() -- Line 55
		--[[ Upvalues[3]:
	...
	if MarketplaceServiceWrapper_upvr:getBaseIdFromGenericId(arg1) == arg1 then
		...
		local var24_upvw
		local pcall_result1_7, pcall_result2_4 = pcall(function() -- Line 64
			--[[ Upvalues[3]:
				[1]: MarketplaceService_upvr (copied, readonly)
		...
		pcall_result1_3 = pcall_result1_7
		var22 = pcall_result2_4
	end
	if pcall_result1_3 then
		pcall_result1_7 = var22.Name
		local var27 = pcall_result1_7
		if not var27 then
			var27 = pcall_result2_6.Name
		end
		module.asset_name = var27
		module.asset_type_id = pcall_result2_6.AssetTypeId
		module.price_in_robux = pcall_result2_6.PriceInRobux
		module.is_for_sale = pcall_result2_6.IsForSale
		module.creator_id = pcall_result2_6.Creator.CreatorTargetId
		if arg2 == Enum.InfoType.Product then
			module.item_id = pcall_result2_6.ProductId
		elseif arg2 == Enum.InfoType.GamePass then
			module.item_id = arg1
		else
			module.item_id = pcall_result2_6.AssetId
		end
...
local function PlayerOwnsAsset_upvr(arg1, arg2, arg3) -- Line 95, Named "PlayerOwnsAsset"
	...
	if arg3 == Enum.InfoType.Asset then
		local pcall_result1_2, pcall_result2_7 = pcall(function() -- Line 99
			--[[ Upvalues[3]:
				[1]: MarketplaceService_upvr (copied, readonly)
				[2]: arg1 (readonly)
				[3]: arg2 (readonly)
		...
		var28 = pcall_result1_2
		var29 = pcall_result2_7
	elseif arg3 == Enum.InfoType.Bundle then
		local pcall_result1, pcall_result2_2 = pcall(function() -- Line 103
			--[[ Upvalues[3]:
				[1]: MarketplaceService_upvr (copied, readonly)
				[2]: arg1 (readonly)
				[3]: arg2 (readonly)
		...
		var28 = pcall_result1
		var29 = pcall_result2_2
	elseif arg3 == Enum.InfoType.GamePass then
		local pcall_result1_6, pcall_result2_5 = pcall(function() -- Line 107
			--[[ Upvalues[3]:
				[1]: MarketplaceService_upvr (copied, readonly)
				[2]: arg1 (readonly)
				[3]: arg2 (readonly)
...
local function _(arg1, arg2, arg3, arg4) -- Line 133, Named "CheckValidity"
	...
	local PlayerOwnsAsset_upvr_result1_4 = PlayerOwnsAsset_upvr(arg1, arg3, arg4)
	if arg2 == nil or PlayerOwnsAsset_upvr_result1_4 == nil then
		return nil
	end
	if PlayerOwnsAsset_upvr_result1_4 or arg2.is_for_sale == false then
		return false
	end
	return true
end
...
local function queuePrompt_upvr(arg1, arg2, arg3, arg4, arg5) -- Line 158, Named "queuePrompt"
	...
	if arg2 == Enum.InfoType.Subscription then
		tbl_3.asset_name = arg3.Name
		tbl_3.price_tier = arg3.PriceTier
		tbl_3.display_price = arg3.DisplayPrice
		tbl_3.subscription_period = arg3.SubscriptionPeriod
		tbl_3.subscription_provider_name = arg3.SubscriptionProviderName
		tbl_3.display_subscription_period = arg3.DisplaySubscriptionPeriod
	...
	tbl_3.asset_name = arg3.asset_name
	tbl_3.base_item_id = arg3.base_item_id
	tbl_3.price_in_robux = arg3.price_in_robux
...
MarketplaceService_upvr.PromptProductPurchaseFinished:Connect(function(arg1, arg2, arg3) -- Line 267, Named "ProductPurchase"
	...
	local PlayerOwnsAsset_upvr_result1_3 = PlayerOwnsAsset_upvr(any_GetPlayerByUserId_result1, arg2, Product)
	local var51
	if GetProductInfo_result1 == nil or PlayerOwnsAsset_upvr_result1_3 == nil then
	...
	if PlayerOwnsAsset_upvr_result1_3 or GetProductInfo_result1.is_for_sale == false then
		var51 = false
	else
		var51 = true
	end
	local var52 = var51
	if var52 ~= nil then
		var51 = queuePrompt_upvr
		var51(any_GetPlayerByUserId_result1, Product, GetProductInfo_result1, var52, arg3)
	end
...
MarketplaceService_upvr.PromptBundlePurchaseFinished:Connect(function(arg1, arg2, arg3) -- Line 280, Named "BundlePurchase"
	...
	local PlayerOwnsAsset_upvr_result1_2 = PlayerOwnsAsset_upvr(arg1, arg2, Bundle)
	local var58
	if tbl_6 == nil or PlayerOwnsAsset_upvr_result1_2 == nil then
		-- KONSTANTWARNING: GOTO [54] #36
	end
	-- KONSTANTERROR: [0] 1. Error Block 19 end (CF ANALYSIS FAILED)
	-- KONSTANTERROR: [45] 29. Error Block 20 start (CF ANALYSIS FAILED)
	if PlayerOwnsAsset_upvr_result1_2 or tbl_6.is_for_sale == false then
		var58 = false
	else
		var58 = true
	end
	local var59 = var58
	if var59 ~= nil then
		var58 = queuePrompt_upvr
		var58(arg1, Bundle, tbl_6, var59, arg3)
	end
...
local function _(arg1, arg2) -- Line 301, Named "isValidSubscription"
	...
	local pcall_result1_4, pcall_result2 = pcall(function() -- Line 302
		--[[ Upvalues[3]:
			[1]: MarketplaceService_upvr (copied, readonly)
			[2]: arg1 (readonly)
			[3]: arg2 (readonly)
	...
	if not pcall_result1_4 then return end
	if pcall_result2.IsSubscribed then
		return true
	end
	return false
end
...
Players_upvr.UserSubscriptionStatusChanged:Connect(function(arg1, arg2) -- Line 363, Named "SubscriptionPurchase"
	...
	local pcall_result1_5, pcall_result2_3 = pcall(function() -- Line 302
		--[[ Upvalues[3]:
			[1]: MarketplaceService_upvr (copied, readonly)
			[2]: arg1 (readonly)
			[3]: arg2 (readonly)
	...
	if not pcall_result1_5 then
		var68 = nil
	elseif pcall_result2_3.IsSubscribed then
		var68 = true
	else
		var68 = false
	end
	if var68 == nil then
		...
		var68 = validateParams_upvr(any_InvokeClient_result2)
		if not var68 then return end
		any_InvokeClient_result2.item_id = arg2
		queuePrompt_upvr(arg1, Enum.InfoType.Subscription, any_InvokeClient_result2, var68, var68)
	end
end)
local function promptWaitTimePassed_upvr(arg1) -- Line 392, Named "promptWaitTimePassed"
	...
	local PlayerOwnsAsset_upvr_result1 = PlayerOwnsAsset_upvr(arg1, 0, {
		Name = "Premium";
	})
	local var79
	if tbl == nil or PlayerOwnsAsset_upvr_result1 == nil then
		-- KONSTANTWARNING: GOTO [30] #25
	end
	-- KONSTANTERROR: [0] 1. Error Block 24 end (CF ANALYSIS FAILED)
	-- KONSTANTERROR: [21] 18. Error Block 25 start (CF ANALYSIS FAILED)
	if PlayerOwnsAsset_upvr_result1 or tbl.is_for_sale == false then
		var79 = false
	else
		var79 = true
	end
	var79 = tbl_5_upvr[arg1]
...
function module_upvr.createMonetizationRemotes(arg1) -- Line 425
	...
	RemoteEvent_2.Name = "PremiumPromptEvent"
	RemoteEvent_2.Parent = BloxbizRemotes
	RemoteEvent_2.OnServerEvent:Connect(function(arg1_2) -- Line 433
		--[[ Upvalues[3]:
		...
		if RateLimiter_upvr:checkRateLimiting(arg1_2) then
			...
			task.delay(30, function() -- Line 438
				...
				if not tbl_5_upvr[arg1_2] then
				elseif 29 <= tick() - tbl_5_upvr[arg1_2] then
	...
	RemoteEvent.Name = "catalogItemPromptEvent"
	RemoteEvent.Parent = BloxbizRemotes
	RemoteEvent.OnServerEvent:Connect(function(arg1_3, arg2) -- Line 454
		--[[ Upvalues[2]:
			[1]: RateLimiter_upvr (copied, readonly)
