...
-- Decompiled on 2025-07-21 08:42:57
-- Luau version 6, Types version 3
-- Time taken: 0.099408 seconds
...
local Content_4_upvr = LeaderboardMenu_upvr_2:WaitForChild("Content")
local var552_upvw
local tbl_23_upvr = {
...
local tbl_62_upvr = {
	Donations = Content_4_upvr:WaitForChild("Donations");
	Levels = Content_4_upvr:WaitForChild("Levels");
	Playtime = Content_4_upvr:WaitForChild("Playtime");
	Stars = Content_4_upvr:WaitForChild("Stars");
}
local tbl_11 = {}
local tbl_28 = {
	Tab = tbl_62_upvr.Levels;
	Text = "Levels";
...
tbl_11[1] = tbl_28
tbl_11[2] = {
	Tab = tbl_62_upvr.Stars;
	Text = "Stars";
	Title = "Stars";
}
tbl_11[3] = {
	Tab = tbl_62_upvr.Playtime;
	Text = "Total Playtime";
	Title = "Playtime";
}
tbl_11[4] = {
	Tab = tbl_62_upvr.Donations;
	Text = "Donations";
	Title = "Donations";
}
tbl_28 = {}
...
local tbl_60 = {
	Donations_Global = tbl_62_upvr.Donations:WaitForChild("3DonationsGlobal");
	Donations_Local = tbl_62_upvr.Donations:WaitForChild("2DonationsLocal");
	Levels_BestTime = tbl_62_upvr.Levels:WaitForChild("2BestTime");
	Levels_LevelSelect = tbl_62_upvr.Levels:WaitForChild("1LevelPanel");
	Levels_TimesCompleted = tbl_62_upvr.Levels:WaitForChild("3Beaten");
	Playtime_Global = tbl_62_upvr.Playtime:WaitForChild("2PlaytimeGlobal");
	Playtime_Local = tbl_62_upvr.Playtime:WaitForChild("1PlaytimeLocal");
	Stars = tbl_62_upvr.Stars:WaitForChild("Stars");
}
local tbl_59_upvr = {
	Donations_Global = tbl_60.Donations_Global:WaitForChild("List");
	Donations_Local = tbl_60.Donations_Local:WaitForChild("List");
	Levels_BestTime = tbl_60.Levels_BestTime:WaitForChild("List");
	Levels_LevelSelect = tbl_60.Levels_LevelSelect:WaitForChild("List");
	Levels_TimesCompleted = tbl_60.Levels_TimesCompleted:WaitForChild("List");
	Playtime_Global = tbl_60.Playtime_Global:WaitForChild("List");
	Playtime_Local = tbl_60.Playtime_Local:WaitForChild("List");
	Stars = tbl_60.Stars:WaitForChild("List");
}
...
local tbl_39_upvr = {
	[tbl_62_upvr.Donations] = {{
		Global = false;
		List = tbl_59_upvr.Donations_Local;
		Panel = tbl_60.Donations_Local;
		Type = module_8_upvr.LeaderboardType.Donations;
	}, {
		Global = true;
		List = tbl_59_upvr.Donations_Global;
		Panel = tbl_60.Donations_Global;
		Type = module_8_upvr.LeaderboardType.Donations;
	}};
	[tbl_62_upvr.Levels] = {{
		Global = false;
		List = tbl_59_upvr.Levels_BestTime;
		Panel = tbl_60.Levels_BestTime;
		Type = module_8_upvr.LeaderboardType.LevelTimeBest;
	}, {
		Global = false;
		List = tbl_59_upvr.Levels_TimesCompleted;
		Panel = tbl_60.Levels_TimesCompleted;
		Type = module_8_upvr.LeaderboardType.LevelCompletions;
	}};
	[tbl_62_upvr.Playtime] = {{
		Global = false;
		List = tbl_59_upvr.Playtime_Local;
		Panel = tbl_60.Playtime_Local;
		Type = module_8_upvr.LeaderboardType.Playtime;
	}, {
		Global = true;
		List = tbl_59_upvr.Playtime_Global;
		Panel = tbl_60.Playtime_Global;
		Type = module_8_upvr.LeaderboardType.Playtime;
	}};
	[tbl_62_upvr.Stars] = {{
		Global = false;
		List = tbl_59_upvr.Stars;
		Panel = tbl_60.Stars;
...
local tbl_74_upvr = {LeaderboardMenu_upvr_2:WaitForChild("Gamemode"), tbl_74_upvr[1]:WaitForChild("Shadow")}
local function _() -- Line 327, Named "SetTitleText"
	--[[ Upvalues[3]:
		[1]: var562_upvr (readonly)
		[2]: tbl_23_upvr (readonly)
		[3]: tbl_74_upvr (readonly)
	]]
...
local Content_upvw = tbl_59_upvr.Levels_LevelSelect:WaitForChild("Content")
local any_I_result1_6_upvr = module_30_upvr.I("Frame", {
	BackgroundTransparency = 1;
	Position = Content_upvw.Position;
	Size = Content_upvw.Size;
	SizeConstraint = Content_upvw.SizeConstraint;
	ZIndex = Content_upvw.ZIndex;
	Parent = tbl_59_upvr.Levels_LevelSelect;
})
local tbl_54 = {
	FillDirection = Enum.FillDirection.Vertical;
	HorizontalAlignment = Enum.HorizontalAlignment.Center;
}
var563 = Content_upvw:WaitForChild("UIGridLayout")
tbl_54.Padding = var563.CellPadding.Y
tbl_54.SortOrder = Enum.SortOrder.LayoutOrder
tbl_54.VerticalAlignment = Enum.VerticalAlignment.Top
tbl_54.Parent = any_I_result1_6_upvr
module_30_upvr.I("UIListLayout", tbl_54)
local Title_upvr = tbl_60.Levels_LevelSelect:WaitForChild("Title")
...
local tbl_64 = {}
local tbl_77 = {}
var563 = Content_upvw:GetChildren()
local children_3_upvw, NONE_5, NONE_7 = Content_upvw:GetChildren()
...
for i_7 = #tbl_77 + 1, children_3_upvw do
	local clone_3 = tbl_77[i_7 - 1]:Clone()
	clone_3.Parent = Content_upvw
	tbl_77[i_7] = clone_3
	local var616
end
...
local function UpdateWorldDisplay_upvr() -- Line 493, Named "UpdateWorldDisplay"
	--[[ Upvalues[7]:
		...
		[5]: tbl_62_upvr (readonly)
		[6]: var562_upvr (readonly)
		[7]: tbl_74_upvr (readonly)
	]]
	-- KONSTANTWARNING: Variable analysis failed. Output will have some incorrect variable assignments
...
local any_I_result1_2_upvr = module_30_upvr.I("TextButton", {
	...
	Text = "";
	ZIndex = 12;
	Parent = tbl_60.Levels_LevelSelect;
})
...
Content_upvw.Visible = not OnWorldsList_2
any_I_result1_2_upvr.Visible = not OnWorldsList_2
any_I_result1_6_upvr.Visible = OnWorldsList_2
tbl_59_upvr.Levels_LevelSelect.Size = tbl_71_upvr[OnWorldsList_2]
...
any_I_result1_2_upvr.Activated:Connect(function() -- Line 568
	...
	Content_upvw.Visible = not OnWorldsList_5
	any_I_result1_2_upvr.Visible = not OnWorldsList_5
	any_I_result1_6_upvr.Visible = OnWorldsList_5
	local Levels_LevelSelect_4 = tbl_59_upvr.Levels_LevelSelect
	Levels_LevelSelect_4.Size = tbl_71_upvr[OnWorldsList_5]
...
local function WorldButtonCreate_upvr(arg1, arg2) -- Line 608, Named "WorldButtonCreate"
	--[[ Upvalues[13]:
		...
		[8]: Content_upvw (readonly)
		[9]: any_I_result1_2_upvr (readonly)
		[10]: tbl_59_upvr (readonly)
		[11]: tbl_71_upvr (readonly)
	...
	any_I_result1.Activated:Connect(function() -- Line 646
		--[[ Upvalues[11]:
			...
			[5]: Content_upvw (copied, readonly)
			[6]: any_I_result1_2_upvr (copied, readonly)
			[7]: any_I_result1_6_upvr (copied, readonly)
			[8]: tbl_59_upvr (copied, readonly)
			[9]: tbl_71_upvr (copied, readonly)
		...
		Content_upvw.Visible = not OnWorldsList_4
		any_I_result1_2_upvr.Visible = not OnWorldsList_4
		any_I_result1_6_upvr.Visible = OnWorldsList_4
		local Levels_LevelSelect = tbl_59_upvr.Levels_LevelSelect
		Levels_LevelSelect.Size = tbl_71_upvr[OnWorldsList_4]
...
for i_13, v_12 in tbl_61 do
	...
	tbl_72[i_13] = any_I_result1_7
	local _
end
local var686 = 0
tbl_72[true].LayoutOrder = var686
for _, _ in tbl_61[true].Worlds do
	local _ = var686 + 1
	local var688
end
local var689_upvw = var688 + 1
local Worlds_upvr = tbl_61[false].Worlds
tbl_72[false].LayoutOrder = var689_upvw
...
Content_upvw = nil
any_I_result1_6_upvr = tbl_62_upvr.Donations
...
task.spawn(tbl_71_upvr)
tbl_71_upvr = module_29_upvr.Signals
tbl_71_upvr.CounterChanged:Connect(function(arg1) -- Line 896
	--[[ Upvalues[4]:
		[1]: module_8_upvr (readonly)
		[2]: tbl_23_upvr (readonly)
		[3]: tbl_62_upvr (readonly)
	...
	if var742 and tbl_23_upvr.ActiveTab == tbl_62_upvr.Donations and LeaderboardMenu_upvr_2.Visible then
		tbl_23_upvr.LeaderboardDirty = true
	end
end)
local any_TextBoundsFlagCreate_result1_upvr = module_24_upvr.TextBoundsFlagCreate(var725, children_3_upvw)
function Content_upvw(arg1, arg2) -- Line 910
	--[[ Upvalues[12]:
...
for i_21, v_19 in var721_upvr, CaculateBestTimeStrings_upvr, var723_upvr do
	...
	tbl_71_upvr = module_4_upvr.Button.Themes.Deemphasized
	var727_upvr = var727_upvr(LeaderboardMenu_upvr_2, tbl_71_upvr)
	local tbl_36 = {}
	tbl_71_upvr = module_10_upvr.FontFaceNormal
	tbl_36.FontFace = tbl_71_upvr
	tbl_71_upvr = UDim2.fromScale(0.95, 0.75)
	tbl_36.Size = tbl_71_upvr
	tbl_71_upvr = v_19.Text
	tbl_36.Text = tbl_71_upvr
	...
	function tbl_71_upvr() -- Line 1026
		--[[ Upvalues[2]:
	...
	var727_upvr(tbl_71_upvr)
	var727_upvr = tbl_23_upvr.TopbarButtons
	tbl_71_upvr = #tbl_23_upvr.TopbarButtons
	tbl_71_upvr = {}
	local var774 = tbl_71_upvr
	var774.Button = var772
	var774.Tab = children_3_upvw
	var727_upvr[tbl_71_upvr + 1] = var774
	if i_21 == 1 then
...
any_I_result1_6_upvr = tbl_59_upvr
var721_upvr = nil
CaculateBestTimeStrings_upvr = nil
...
function CaculateBestTimeStrings_upvr() -- Line 1247
	...
	SetTab_upvr(tbl_62_upvr.Donations)
...
game:GetService("RunService"):BindToRenderStep("DisplayLeaderboards_UPDATE", Enum.RenderPriority.Last.Value + 1, function(arg1) -- Line 1322
	--[[ Upvalues[17]:
		...
		[15]: Content_4_upvr (readonly)
		[16]: module_4_upvr (readonly)
		[17]: Content_upvw (read and write)
	]]
	-- KONSTANTERROR: [0] 1. Error Block 1 start (CF ANALYSIS FAILED)
	...
	local var826
	if tbl_23_upvr.SelectedWorldId and tbl_23_upvr.SelectedLevelIndex then
		var826 = module_11_upvr.Data_ById[tbl_23_upvr.SelectedWorldId].Levels[tbl_23_upvr.SelectedLevelIndex]
	end
	local ActiveTab = tbl_23_upvr.ActiveTab
	local var828
	if ActiveTab ~= tbl_62_upvr.Levels then
		var828 = tbl_23_upvr.LeaderboardData_ByTab[ActiveTab]
		if not var828 then
			...
			tbl_23_upvr.LeaderboardData_ByTab[ActiveTab] = var831
			var828 = var831
			-- KONSTANTWARNING: GOTO [183] #128
		end
	elseif var826 then
		if not tbl_23_upvr.LeaderboardData_ByLevelId[var826.Id] then
			i_29 = tbl_39_upvr
			for i_30, v_27 in i_29[ActiveTab] do
				({})[i_30] = {
					_Initialized = false;
					_DataPending = false;
					_ExpiresAt = 0;
			...
			tbl_23_upvr.LeaderboardData_ByLevelId[var826.Id] = var834
			-- KONSTANTWARNING: GOTO [183] #128
		end
	else
		for var820, var821 in tbl_39_upvr[ActiveTab] do
			local tbl_50 = {}
			tbl_50._Initialized = false
			tbl_50._DataPending = false
			tbl_50._ExpiresAt = 0
			tbl_50.Global = false
			tbl_50.Type = var821.Type
			tbl_50.LevelId = nil
			tbl_50.Data = {}
			v_27 = tbl_50
			local var836 = v_27
			var836._Initialized = true
			var836._ExpiresAt = math.huge
			;({})[var820] = var836
		end
	end
	-- KONSTANTERROR: [11] 9. Error Block 184 end (CF ANALYSIS FAILED)
end)
SetTab_upvr(tbl_62_upvr.Levels)