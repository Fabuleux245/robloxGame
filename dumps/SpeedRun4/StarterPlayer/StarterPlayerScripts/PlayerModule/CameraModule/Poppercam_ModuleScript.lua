...
-- Decompiled on 2025-07-21 10:38:53
...
local function _(arg1) -- Line 13, Named "cframeToAxis"
...
local function _(arg1) -- Line 18, Named "axisToCFrame"
	--[[ Upvalues[1]:
...
local function _(arg1) -- Line 26, Named "extractRotation"
...
tbl_upvr.new = new
function tbl_upvr.Step(arg1, arg2, arg3) -- Line 37
	--[[ Upvalues[1]:
		[1]: zero_cframe_upvr (readonly)
	]]
	...
	return {
		extrapolate = function(arg1_2) -- Line 52, Named "extrapolate"
			--[[ Upvalues[5]:
...
function tbl_upvr.Reset(arg1) -- Line 65
	arg1.lastCFrame = nil
end
...
function setmetatable_result1_2_upvr.new() -- Line 75
	--[[ Upvalues[3]:
...
function setmetatable_result1_2_upvr.GetOcclusionMode(arg1) -- Line 81
	return Enum.DevCameraOcclusionMode.Zoom
end
function setmetatable_result1_2_upvr.Enable(arg1, arg2) -- Line 85
	arg1.focusExtrapolator:Reset()
end
local module_upvr = require(script.Parent:WaitForChild("ZoomController"))
function setmetatable_result1_2_upvr.Update(arg1, arg2, arg3, arg4, arg5) -- Line 89
	--[[ Upvalues[1]:
...
function setmetatable_result1_2_upvr.CharacterAdded(arg1, arg2, arg3) -- Line 102
end
function setmetatable_result1_2_upvr.CharacterRemoving(arg1, arg2, arg3) -- Line 106
end
function setmetatable_result1_2_upvr.OnCameraSubjectChanged(arg1, arg2) -- Line 109
end
