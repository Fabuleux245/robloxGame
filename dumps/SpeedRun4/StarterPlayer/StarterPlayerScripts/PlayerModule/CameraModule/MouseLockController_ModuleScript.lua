...
-- Decompiled on 2025-07-21 10:38:52
-- Luau version 6, Types version 3
-- Time taken: 0.005723 seconds
...
function module_upvr.new() -- Line 31
	...
	if StringValue then
		StringValue.Changed:Connect(function(arg1) -- Line 56
			--[[ Upvalues[1]:
...
function module_upvr.GetIsMouseLocked(arg1) -- Line 84
	return arg1.isMouseLocked
end
function module_upvr.GetBindableToggleEvent(arg1) -- Line 88
	return arg1.mouseLockToggledEvent.Event
end
local UserFixCameraOffsetJitter_upvr = require(game:GetService("ReplicatedStorage"):WaitForChild("FeatureFlags")).UserFixCameraOffsetJitter
function module_upvr.GetMouseLockOffset(arg1) -- Line 92
	--[[ Upvalues[2]:
		[1]: UserFixCameraOffsetJitter_upvr (readonly)
		[2]: Players_upvr (readonly)
	]]
	if UserFixCameraOffsetJitter_upvr then
		if Players_upvr.LocalPlayer and Players_upvr.LocalPlayer.Character and Players_upvr.LocalPlayer.Character.Humanoid and Players_upvr.LocalPlayer.Character.Humanoid.CameraOffset ~= Vector3.new() then
			-- KONSTANTERROR: Expression was reused, decompilation is incorrect
			return Players_upvr.LocalPlayer.Character.Humanoid.CameraOffset
		end
...
function module_upvr.UpdateMouseLockAvailability(arg1) -- Line 128
	--[[ Upvalues[2]:
...
function module_upvr.OnBoundKeysObjectChanged(arg1, arg2) -- Line 140
...
function module_upvr.OnMouseLockToggled(arg1) -- Line 155
	--[[ Upvalues[1]:
...
function module_upvr.DoMouseLockSwitch(arg1, arg2, arg3, arg4) -- Line 180
...
function module_upvr.BindContextActions(arg1) -- Line 188
	--[[ Upvalues[2]:
		[1]: ContextActionService_upvr (readonly)
		[2]: Value_upvr (readonly)
	]]
	ContextActionService_upvr:BindActionAtPriority("MouseLockSwitchAction", function(arg1_2, arg2, arg3) -- Line 189
		--[[ Upvalues[1]:
			[1]: arg1 (readonly)
		]]
...
function module_upvr.UnbindContextActions(arg1) -- Line 194
	--[[ Upvalues[1]:
		[1]: ContextActionService_upvr (readonly)
	]]
	ContextActionService_upvr:UnbindAction("MouseLockSwitchAction")
end
function module_upvr.IsMouseLocked(arg1) -- Line 198
...
function module_upvr.EnableMouseLock(arg1, arg2) -- Line 202
	--[[ Upvalues[1]:
		[1]: module_upvr_2 (readonly)
	]]
