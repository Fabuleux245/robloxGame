...
local function GetProductInfo_upvr(arg1, arg2) -- Line 53, Named "GetProductInfo"
	...
	-- KONSTANTERROR: [30] 25. Error Block 25 start (CF ANALYSIS FAILED)
	pcall_result1_5 = tbl.Name
	local var27 = pcall_result1_5
	if not var27 then
		var27 = pcall_result2_4.Name
	end
	tbl_6.asset_name = var27
	tbl_6.asset_type_id = pcall_result2_4.AssetTypeId
	tbl_6.price_in_robux = pcall_result2_4.PriceInRobux
	tbl_6.is_for_sale = pcall_result2_4.IsForSale
	tbl_6.creator_id = pcall_result2_4.Creator.CreatorTargetId
	if arg2 == Enum.InfoType.Product then
		tbl_6.item_id = pcall_result2_4.ProductId
		-- KONSTANTWARNING: GOTO [75] #49
	end
	-- KONSTANTERROR: [30] 25. Error Block 25 end (CF ANALYSIS FAILED)
end
local function PlayerOwnsAsset_upvr(arg1, arg2, arg3) -- Line 95, Named "PlayerOwnsAsset"
	...
	elseif arg3.Name == "Premium" then
		...
		if tbl_upvr[arg1] then
			if tbl_10_upvr[arg1] ~= Enum.MembershipType.Premium then
			else
			end
...
local function queuePrompt_upvr(arg1, arg2, arg3, arg4, arg5) -- Line 158, Named "queuePrompt"
	...
	if arg2 == Enum.InfoType.Subscription then
		tbl_7.asset_name = arg3.Name
		tbl_7.price_tier = arg3.PriceTier
		tbl_7.display_price = arg3.DisplayPrice
		tbl_7.subscription_period = arg3.SubscriptionPeriod
		tbl_7.subscription_provider_name = arg3.SubscriptionProviderName
		tbl_7.display_subscription_period = arg3.DisplaySubscriptionPeriod
	...
	tbl_7.asset_name = arg3.asset_name
	tbl_7.base_item_id = arg3.base_item_id
	tbl_7.price_in_robux = arg3.price_in_robux
...
MarketplaceService_upvr.PromptBundlePurchaseFinished:Connect(function(arg1, arg2, arg3) -- Line 280, Named "BundlePurchase"
	...
	local var57
	if tbl_8 == nil or PlayerOwnsAsset_result1_5 == nil then
		-- KONSTANTWARNING: GOTO [54] #36
	end
	-- KONSTANTERROR: [0] 1. Error Block 19 end (CF ANALYSIS FAILED)
	-- KONSTANTERROR: [45] 29. Error Block 20 start (CF ANALYSIS FAILED)
	if PlayerOwnsAsset_result1_5 or tbl_8.is_for_sale == false then
		var57 = false
	else
		var57 = true
	end
	...
	if var58 ~= nil then
		...
		var57(arg1, Bundle, tbl_8, var58, arg3)
	end
...
local function promptWaitTimePassed_upvr(arg1) -- Line 392, Named "promptWaitTimePassed"
	...
	local var78
	if tbl_2 == nil or PlayerOwnsAsset_result1_2 == nil then
		-- KONSTANTWARNING: GOTO [30] #25
	end
	-- KONSTANTERROR: [0] 1. Error Block 24 end (CF ANALYSIS FAILED)
	-- KONSTANTERROR: [21] 18. Error Block 25 start (CF ANALYSIS FAILED)
	if PlayerOwnsAsset_result1_2 or tbl_2.is_for_sale == false then
		var78 = false
	else
		var78 = true
	end
	var78 = tbl_5_upvr[arg1]
...
Players_upvr.PlayerAdded:Connect(function(arg1) -- Line 417
	...
	tbl_10_upvr[arg1] = arg1.MembershipType
end)
