...
local function getStartOffset() -- Line 73
	...
	return tbl_3_upvr.left.getOffset() + module_2_upvr.leftGap
end
tbl_5.getStartOffset = getStartOffset
tbl_5.records = {}
tbl_3_upvr.left = tbl_5
local tbl = {
	startScale = 0.5;
}
...
tbl_3_upvr.right = {
	...
	getStartOffset = function(arg1) -- Line 100, Named "getStartOffset"
		...
		return -arg1 - tbl_3_upvr.right.getOffset()
	end;
	records = {};
}
...
function module_2_upvr.updateTopbar() -- Line 254
	...
	local function getIncrement_upvr(arg1, arg2) -- Line 255, Named "getIncrement"
		...
		local any_get_result1_3 = arg1:get("iconSize", arg1:getIconState())
		if not any_get_result1_3 then
			any_get_result1_3 = UDim2.new(0, 32, 0, 32)
		end
		local var79 = any_get_result1_3.X.Offset + module_2_upvr[arg2.."Gap"]
		local var80 = 0
	...
	task.defer(function() -- Line 275
		...
		for i_6, _ in pairs(tbl_2_upvr) do
			if module_2_upvr.canShowIconOnTopbar(i_6) then
				var136 = "alignment"
				var136 = tbl_3_upvr[i_6:get(var136)].records
				table.insert(var136, i_6)
			end
		end
		local ViewportSize = workspace.CurrentCamera.ViewportSize
		for i_7, v_7 in pairs(tbl_3_upvr) do
		...
		local function _(arg1, arg2, arg3) -- Line 333, Named "getBoundaryX"
			...
			local any_getMenuOffset_result1_3, any_getMenuOffset_result2_3 = module_2_upvr.getMenuOffset(arg1)
			local var172
			...
			if arg2 ~= "left" or not INLINED() then
				var172 = false
				if arg2 == "right" then
					var172 = arg1:get("iconSize", arg1:getIconState()).X.Offset + var169 + any_getMenuOffset_result2_3
				end
			end
		...
		local pairs_result1_4, pairs_result2_6, pairs_result3 = pairs(tbl_3_upvr)
					...
					if not arg1_7 then
						...
						local function updateHealthBar() -- Line 890
							...
							local function INLINED_5() -- Internal function, doesn't exist in bytecode
								var244 = module_2_upvr
								return var244.healthbarDisabled
							end
							if var243 == 1 or INLINED_5() or var238_upvw and StarterGui_upvr:GetCoreGuiEnabled(Enum.CoreGuiType.Health) == false then
								var244 = arg1
								if var244.enabled then
									arg1:setEnabled(false)
								end
							else
								if var243 < 1 then
									var244 = arg1
									if not var244.enabled then
								...
								if 0.5 >= var243 or not Color3_fromRGB_result1_upvr_3 then
									local var246 = Color3_fromRGB_result1_upvr
								end
								if 0.5 >= var243 or not Color3_fromRGB_result1_upvr then
									local var247 = Color3_fromRGB_result1_upvr_2
								end
								local var248 = (1 - var244) * 2
								if 0.5 >= var243 or not (1 - var248) then
								end
								local var249 = nil or 2
								local var250 = var249
								local var251 = var249
								local any_Lerp_result1 = Color3.new(math.pow(var247.R, var250), math.pow(var247.G, var250), math.pow(var247.B, var250)):Lerp(Color3.new(math.pow(var246.R, var251), math.pow(var246.G, var251), math.pow(var246.B, var251)), 2 - var248)
...
coroutine.wrap(function() -- Line 962
	...
	for var325, v_12 in pairs(tbl_3_upvr) do
		if var325 ~= "mid" then
