...
-- Decompiled on 2025-07-21 10:41:17
...
return function(arg1) -- Line 36, Named "GetPreviewFrameViewport"
	...
	local Value_upvr_result1_upvr_3 = Value_upvr(0)
	local var7_result1_upvr = Computed_upvr(function() -- Line 46
		...
		return {Value_upvr_result1_upvr_5:get(), Value_upvr_result1_upvr_3:get()}
	end)
	...
	RunService_upvr:BindToRenderStep("AvatarModelRotation", 2000, function(arg1_2) -- Line 65
		--[[ Upvalues[8]:
			...
			[7]: Value_upvr_result1_upvr_3 (readonly)
		...
		if UserInputService_upvr.TouchEnabled then
			...
			if Value_upvr_result1_upvr:get() then
				Value_upvr_result1_upvr_3:set((Value_upvr_result1_upvr_3:get()) + (mouse_upvr.X - X_upvw))
	...
	local tbl = {
		...
		Visible = false;
		[module_upvr.Ref] = Value_upvr_result1_upvr_4;
		[OnEvent_upvr("AncestryChanged")] = function() -- Line 116
			...
			local any_get_result1_2 = Value_upvr_result1_upvr_4:get()
			if any_get_result1_2 then
				local any_findFirstAncestorOfClass_result1 = Utils_2_upvr.findFirstAncestorOfClass(any_get_result1_2, "ScreenGui")
	...
	local tbl_2 = {
		...
		[OnEvent_upvr("TouchPan")] = function(arg1_3, arg2, arg3) -- Line 179
			...
			if Value_upvr_result1_upvr_2:get() then
				...
				Value_upvr_result1_upvr_3:set(Value_upvr_result1_upvr_3:get() + arg3.X * var10_upvw)
	...
	return {
		...
		ResetRotation = function() -- Line 59, Named "ResetRotation"
			...
			Value_upvr_result1_upvr_3:set(0)
		end;
	}
end