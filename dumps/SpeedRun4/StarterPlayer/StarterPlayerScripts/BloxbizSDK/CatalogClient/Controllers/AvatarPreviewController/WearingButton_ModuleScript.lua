...
-- Decompiled on 2025-07-21 10:41:19
...
return function(arg1, arg2) -- Line 82, Named "WearingItems"
	...
	local any_onChange_result1_upvr = Observer_upvr(arg2):onChange(function() -- Line 92
		...
		if GetTableType_result1_2 == "Array" then
			...
			local var41
			-- KONSTANTWARNING: GOTO [29] #25
		end
		-- KONSTANTERROR: [0] 1. Error Block 23 end (CF ANALYSIS FAILED)
		-- KONSTANTERROR: [15] 13. Error Block 24 start (CF ANALYSIS FAILED)
		if GetTableType_result1_2 == "Dictionary" then
			var41 = 0
		...
		Value_upvr_result1_upvr_4:get().Text = var40
		-- KONSTANTERROR: [15] 13. Error Block 24 end (CF ANALYSIS FAILED)
	end)
	module_3[Cleanup_upvr] = function() -- Line 169
		--[[ Upvalues[1]:
			[1]: any_onChange_result1_upvr (readonly)
		]]
		any_onChange_result1_upvr()
	end
	module_3[Children_upvr] = {New_upvr("TextLabel")({
		Name = "TextLabel";
	...
	module_3[OnEvent_upvr("Activated")] = function() -- Line 215
		--[[ Upvalues[2]:
			[1]: Value_upvr_result1_upvr_2 (readonly)
			[2]: arg1 (readonly)
		]]
	...
	module_3[OnEvent_upvr("MouseButton1Down")] = function() -- Line 220
		--[[ Upvalues[1]:
			[1]: Value_upvr_result1_upvr_3 (readonly)
		]]
		Value_upvr_result1_upvr_3:set(true)
	end
	module_3[OnEvent_upvr("MouseButton1Up")] = function() -- Line 224
		--[[ Upvalues[1]:
			[1]: Value_upvr_result1_upvr_3 (readonly)
		]]
		Value_upvr_result1_upvr_3:set(false)
	end
	module_3[OnEvent_upvr("MouseEnter")] = function() -- Line 228
		--[[ Upvalues[1]:
			[1]: Value_upvr_result1_upvr (readonly)
		]]
		Value_upvr_result1_upvr:set(true)
	end
	module_3[OnEvent_upvr("MouseLeave")] = function() -- Line 232
		--[[ Upvalues[2]:
			[1]: Value_upvr_result1_upvr (readonly)
	...
	return New_upvr("TextButton")(module_3)
end