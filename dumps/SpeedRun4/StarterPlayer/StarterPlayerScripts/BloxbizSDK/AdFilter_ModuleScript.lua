...
-- Decompiled on 2025-07-21 10:40:39
-- Luau version 6, Types version 3
-- Time taken: 0.011655 seconds
...
function module_6_upvr.Build2DAdItem(arg1, arg2, arg3) -- Line 68
	...
	module.external_link_references = external_link_references_2
	module.gif_fps = math.floor(tonumber(arg2.gif_fps or 15))
	module.gif_version = arg2.gif_version or 2
	module.audio_url = arg2.audio_url
	module.ad_disclaimer_url = arg3.url
	module.ad_disclaimer_scale_x = arg3.scale_x
	module.ad_disclaimer_scale_y = arg3.scale_y
	local ad_url_2 = module.ad_url
	if type(ad_url_2) == "string" then
		module.ad_url = {ad_url_2}
	end
	return module
end
function module_6_upvr.Build3DAdItem(arg1, arg2, arg3) -- Line 91
	...
	module_2.external_link_references = external_link_references
	module_2.ad_disclaimer_text = arg3.text
	return module_2
end
...
function module_6_upvr.SelectAdToDisplay(arg1, arg2) -- Line 153
	...
	local module_4 = {}
	local var40 = 0
	local _, ipairs_result2_3, ipairs_result3 = ipairs(arg2)
	local var44
	for i_2, v_2 in var44, ipairs_result2_3, ipairs_result3 do
		...
		table.insert(module_4, any_getFinalAdDeliveryRatio_result1)
	end
	var44 = arg2[1]
	if var44 then
	...
	return FilterUtils_upvr.PythonChoices(module_3, module_4)[1]
end
...
function module_6_upvr.GetAds(arg1, arg2, arg3) -- Line 208
	...
	local var71
	if not arg2.blocklist then
	end
	local var72 = arg2.portal_ad_request or false
	local part_size_x = arg2.part_size_x
	local part_size_y = arg2.part_size_y
	local part_size_z = arg2.part_size_z
	local tbl_3 = {}
	if var72 then
		var71 = "portal"
		table.insert(tbl_3, var71)
	elseif arg2["3d_ad_request"] or false then
		var71 = "3d"
		table.insert(tbl_3, var71)
	else
		var71 = "static"
	...
	var71 = arg2
	FilterUtils_upvr.ValidateParams(GET_ADS_PARAMETERS_upvr, var71)
	local players = arg2.players
	arg2.players = nil
	local var78 = arg3
	if not var78 then
		var78 = module_6_upvr:GetAllEnabledAds()
	end
	var71 = Filters_upvr:FilterAdsByAdFormat(var78, tbl_3)
	var71 = Filters_upvr:FilterAdsByGameTargeting(var71, tonumber(arg2.bloxbiz_version or 0), arg2.part_name)
	if var72 then
		var71 = Filters_upvr:FilterAdsBySizePortal(var71, part_size_x, part_size_y, part_size_z)
		-- KONSTANTWARNING: GOTO [170] #131
	end
	-- KONSTANTERROR: Expression was reused, decompilation is incorrect
	if arg2["3d_ad_request"] or false then
		var71 = Filters_upvr:FilterAdsBySize3D(var71, part_size_x, part_size_y, part_size_z)
	else
		var71 = Filters_upvr:FilterAdsBySize2D(var71, tonumber(tostring(FilterUtils_upvr.Round(FilterUtils_upvr.SafeDiv(arg2.surface_gui_size_y or 0, arg2.surface_gui_size_x or 0), 4))))
	end
	var71 = Filters_upvr:FilterAdsByBlocklist(var71, {})
	for _, v_3 in ipairs(players) do
		table.insert({}, v_3.player_id)
		local var83
	end
	for _, v_4 in ipairs(var83) do
		local any_Get_result1 = InferredPlayerData_upvr:Get(v_4)
		local gender = any_Get_result1.gender
		;({})[v_4] = gender
		local _
	end
	local ipairs_result1, ipairs_result2, ipairs_result3_3 = ipairs(players)
	-- KONSTANTERROR: [0] 1. Error Block 58 end (CF ANALYSIS FAILED)
	-- KONSTANTERROR: [306] 235. Error Block 33 start (CF ANALYSIS FAILED)
	-- KONSTANTWARNING: Failed to evaluate expression, replaced with nil [306.43]
	;({})[any_Get_result1] = nil
	FilterUtils_upvr.ValidateParams(GET_ADS_PLAYER_PARAMETERS_upvr, gender)
	local var93 = gender
	-- KONSTANTWARNING: Failed to evaluate expression, replaced with nil [314.37]
	var93.player_device = nil
	-- KONSTANTWARNING: Failed to evaluate expression, replaced with nil [316.38]
	var93.gender = nil
	-- KONSTANTERROR: Expression was reused, decompilation is incorrect
	var93.ad_url = nil.ad_url
	-- KONSTANTERROR: Expression was reused, decompilation is incorrect
	var93.bloxbiz_ad_id = nil.bloxbiz_ad_id
	var93.timestamp = tonumber(os.time())
	FilterUtils_upvr.PythonUpdate(var93, arg2)
	table.insert({}, FilterUtils_upvr.CapIntegerValues(var93))
	-- KONSTANTERROR: [306] 235. Error Block 33 end (CF ANALYSIS FAILED)
	-- KONSTANTERROR: [220] 166. Error Block 52 start (CF ANALYSIS FAILED)
	-- KONSTANTWARNING: Failed to evaluate expression, replaced with nil [354.36]
	if not nil then
	end
	if var72 then
		-- KONSTANTWARNING: GOTO [306] #235
	end
	-- KONSTANTERROR: [220] 166. Error Block 52 end (CF ANALYSIS FAILED)
end
