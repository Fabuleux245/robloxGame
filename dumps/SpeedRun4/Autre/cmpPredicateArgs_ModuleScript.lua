...
return function(arg1, arg2) -- Line 4
	...
	if arg1.n ~= arg2.n then
		return false, "number of args in "..fmtArgs_upvr(arg2).." does not match number of predicates"
	end
	for i = 1, arg2.n do
		if not arg1[i](arg2[i]) then
			return false, fmtArgs_upvr(arg2).." does not match predicates at position "..i
		end
	end
	return true
end