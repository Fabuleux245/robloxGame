...
return function(arg1, arg2, arg3) -- Line 26, Named "insideAbove"
	...
	return returnValue_upvr(true, "Was not below the element", "Was too far below the element")
end