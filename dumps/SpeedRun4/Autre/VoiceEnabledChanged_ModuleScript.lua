...
-- Decompiled on 2025-07-21 10:42:49
...
return require(CorePackages.Packages.Rodux).makeActionCreator(script.Name, function(arg1) -- Line 15
	--[[ Upvalues[2]:
		[1]: maybeAssert_upvw (read and write)
		[2]: t_upvr (readonly)
	]]
	maybeAssert_upvw(t_upvr.boolean(arg1))
	local module = {}
	module.enabled = arg1
	return module
end)