...
-- Decompiled on 2025-07-21 10:11:47
...
local module = {
	...
	onTriggerVisualTreatment = function(arg1, arg2) -- Line 21, Named "onTriggerVisualTreatment"
		...
		local tbl = {
			...
			treatmentType = Constants_upvr.TreatmentType.ChatNudgeDialog;
			isShown = true;
		}
		tbl.detail = arg2
		arg1(tbl)
...
function module.onTriggerEventReceived(arg1) -- Line 30
	...
	InExperienceInterventionAnalytics_upvr.sendAnalyticsEvent(InExperienceInterventionAnalytics_upvr.Constants.EventTypes.ModalMessageReceived, InExperienceInterventionAnalytics_upvr.Constants.InterventionTypes.Nudge, DateTime.now().UnixTimestampMillis, arg1.decisionEventId, arg1.evidence, arg1.timeoutDurationSeconds)
end
return module