...
-- Decompiled on 2025-07-21 08:56:36
...
return function(arg1) -- Line 6
	...
	return arg1.roduxNetworking.POST({
		Name = "ResetConversationUniverse";
		...
		local module_2 = {}
		module_2[1] = arg2
		return arg1_2(CHAT_URL_upvr):path("v2"):path("reset-conversation-universe"):body(module):setStatusIds(module_2)
	end)
end