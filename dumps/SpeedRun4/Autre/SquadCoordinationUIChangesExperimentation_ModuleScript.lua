...
-- Decompiled on 2025-07-21 10:28:46
...
local game_DefineFastString_result1_upvr = game:DefineFastString("SquadCoordinationUiExperimentLayer", "Party.Coordination.UI")
local game_DefineFastFlag_result1_upvr = game:DefineFastFlag("EnablePartyCoordinationUiChanges3", false)
local var4_upvr = game:DefineFastFlag("PartyCoordinationUIExposureEnabled", false) and game_DefineFastFlag_result1_upvr
local function _(arg1) -- Line 16, Named "getIsUserInTreatment"
	--[[ Upvalues[2]:
...
local game_DefineFastFlag_result1_upvr_2 = game:DefineFastFlag("ForceEnablePartyCoordinationUiChanges3", false)
local game_DefineFastString_result1_upvr_2 = game:DefineFastString("SquadEnablePartyCoordinationUiVariant", "enablePartyCoordinationUi")
return {
	getPartyCoordinationUiChangesEnabled = function() -- Line 26, Named "getPartyCoordinationUiChangesEnabled"
		--[[ Upvalues[5]:
	...
	logExposure = function() -- Line 34, Named "logExposure"
		--[[ Upvalues[3]:
