...
-- Decompiled on 2025-07-21 10:48:45
...
return function(arg1) -- Line 9, Named "UnblockPlayer"
	--[[ Upvalues[2]:
	...
	return function(arg1_2) -- Line 10
		...
		coroutine.wrap(function() -- Line 11
			...
			if BlockingUtility_upvr:UnblockPlayerAsync(arg1) then
				arg1_2:dispatch(SetPlayerIsBlocked_upvr(arg1, false))
			end
		end)()
	end
end