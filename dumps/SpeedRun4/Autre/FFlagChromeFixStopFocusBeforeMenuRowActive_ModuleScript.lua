...
-- Decompiled on 2025-07-21 10:21:20
...
if module_2 then
	...
	if module_2 then
		module_2 = require(Parent_2:WaitForChild("FFlagConsoleChatOnExpControls"))
		if module_2 then
			module_2 = game:DefineFastFlag("ChromeFixStopFocusBeforeMenuRowActive2", false)
		end
	end
end
return module_2