...
-- Decompiled on 2025-07-21 09:32:42
...
local BigGameIconReducer_upvr = require(GameIconRodux.BigGameIcons.BigGameIconReducer)
...
return function(arg1, arg2, arg3) -- Line 12
	--[[ Upvalues[5]:
		[1]: BigGameIconReducer_upvr (readonly)
		[2]: Promise_upvr (readonly)
		[3]: ApiFetchThumbnails_upvr (readonly)
		[4]: GamesGetIcons_upvr (readonly)
		[5]: SetBigGameIcons_upvr (readonly)
	]]
	return function(arg1_2) -- Line 13
		--[[ Upvalues[8]:
			[1]: BigGameIconReducer_upvr (copied, readonly)
			[2]: arg2 (readonly)
			...
			[8]: SetBigGameIcons_upvr (copied, readonly)
		]]
		local module = {}
		for _, v in pairs(arg2) do
			if arg1_2:getState()[BigGameIconReducer_upvr.key][v] == nil then
		...
		return ApiFetchThumbnails_upvr.Fetch(arg1, module, arg3 or "512x512", "Game", GamesGetIcons_upvr, SetBigGameIcons_upvr, arg1_2)
	end
end