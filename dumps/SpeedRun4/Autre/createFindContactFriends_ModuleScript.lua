...
-- Decompiled on 2025-07-21 08:56:46
...
local game_GetFastString_result1_upvr = game:GetFastString("ContactImporterFindFriendsUrl")
return function(arg1) -- Line 8
	...
	}, function(arg1_2) -- Line 11
		--[[ Upvalues[2]:
			[1]: API_URL_upvr (copied, readonly)
			[2]: game_GetFastString_result1_upvr (copied, readonly)
		]]
		return arg1_2(API_URL_upvr):path("contacts-api"):path("v1"):path(game_GetFastString_result1_upvr)
	end)
end