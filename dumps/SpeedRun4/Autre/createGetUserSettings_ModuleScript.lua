...
return function(arg1) -- Line 5
	...
	return arg1.roduxNetworking.GET(script, function(arg1_2, arg2) -- Line 10
		--[[ Upvalues[1]:
			[1]: API_URL_upvr (copied, readonly)
		]]
		return arg1_2(API_URL_upvr):path("user-settings-api"):path("v1"):path("user-settings"):queryArgs(arg2)
	end)
end