...
-- Decompiled on 2025-07-21 10:52:05
-- Luau version 6, Types version 3
-- Time taken: 0.000415 seconds

local Colors_upvr = require(script.Parent.Colors)
return function() -- Line 4, Named "getSelectionImageObjectRounded"
	--[[ Upvalues[1]:
		[1]: Colors_upvr (readonly)
	]]
	local ImageLabel = Instance.new("ImageLabel")
	ImageLabel.Image = "rbxasset://textures/ui/InspectMenu/selection_rounded.png"
