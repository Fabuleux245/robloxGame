...
-- Decompiled on 2025-07-21 10:26:50
-- Luau version 6, Types version 3
-- Time taken: 0.000605 seconds

game:DefineFastFlag("UseLargerCDLCodeFontForVRV2", false)
return function() -- Line 3
	...
	if not game_GetEngineFeature_result1 then
		game_GetEngineFeature_result1 = game:GetFastFlag("UseLargerCDLCodeFontForVRV2")
	end
