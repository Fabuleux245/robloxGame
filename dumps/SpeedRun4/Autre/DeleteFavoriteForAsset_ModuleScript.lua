...
local var7_upvr = require(Parent.createInspectAndBuyKeyMapper)("deleteFavoriteForAsset")
...
return function(arg1) -- Line 26, Named "DeleteFavoriteForAsset"
	--[[ Upvalues[12]:
	...
	return Thunk_upvr.new(script.Name, module_upvr, function(arg1_2, arg2) -- Line 27
		...
		return PerformFetch_upvr.Single(var7_upvr(arg1_2:getState().storeId, arg1), function(arg1_3) -- Line 33
			...
			return var18_upvr.deleteFavoriteForAsset(arg1):andThen(function() -- Line 34
				--[[ Upvalues[9]:
				...
				arg1_2:dispatch(SetFavoriteAsset_upvr(arg1, false))
				...
				var16_upvr.reportFavoriteItem("Asset", arg1, false, true, "", numFavorites - 1)
				arg1_2:dispatch(SendCounter_upvr(Constants_upvr.Counters.DeleteFavoriteForAsset..Constants_upvr.CounterSuffix.RequestSucceeded))
				return Promise_upvr.resolve()
			end, function(arg1_4) -- Line 45
				--[[ Upvalues[4]:
					[1]: arg1_2 (copied, readonly)
				...
				arg1_2:dispatch(SendCounter_upvr(Constants_upvr.Counters.DeleteFavoriteForAsset..Constants_upvr.CounterSuffix.RequestRejected))
				return Promise_upvr.reject(tostring(arg1_4.StatusMessage))
			end)
		end)(arg1_2):catch(function(arg1_5) -- Line 51
			--[[ Upvalues[5]:
				[1]: arg1_2 (readonly)
				[2]: arg1 (copied, readonly)
			...
			var16_upvr.reportFavoriteItem("Asset", arg1, false, false, arg1_5, arg1_2:getState().assets[arg1].numFavorites)
			arg1_2:dispatch(SendCounter_upvr(Constants_upvr.Counters.DeleteFavoriteForAsset..Constants_upvr.CounterSuffix.RequestFailed))
		end)
	end)
end