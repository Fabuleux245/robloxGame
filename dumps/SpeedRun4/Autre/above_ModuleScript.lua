...
-- Decompiled on 2025-07-21 08:45:06
...
return function(arg1, arg2, arg3) -- Line 38, Named "above"
	--[[ Upvalues[2]:
		[1]: toRect_upvr (readonly)
		[2]: returnValue_upvr (readonly)
	]]
	-- KONSTANTWARNING: Variable analysis failed. Output will have some incorrect variable assignments
	local var3 = -(toRect_upvr(arg1).Max - toRect_upvr(arg2).Min)
	local var4
	if var4 then
	...
	return returnValue_upvr(true, "Was above the element", "Was below the element")
end