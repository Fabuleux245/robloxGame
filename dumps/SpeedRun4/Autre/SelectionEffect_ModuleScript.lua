...
local any_extend_result1 = Roact_upvr.PureComponent:extend("SelectionEffect")
...
function any_extend_result1.render(arg1) -- Line 13
	...
	return Roact_upvr.createElement("Frame", module, {
		SelectedLine = Roact_upvr.createElement("ImageLabel", {
			AnchorPoint = Vector2.new(1, 0.5);
			Position = UDim2.new(0.5 + Constants_upvr.InnerCircleSizeRatio / 2, -var5.SelectedLinePadding, 0.5, 0);
			Size = UDim2.new(1, 0, Constants_upvr.InnerCircleSizeRatio * math.sin(math.rad(360 / Constants_upvr.EmotesPerPage / 2)), -var5.SelectedLinePadding);
			BackgroundTransparency = 1;
			Image = var5.SelectedLine;
			ZIndex = 4;
		}, {
			AsspectRatioConstraint = Roact_upvr.createElement("UIAspectRatioConstraint", {
				AspectRatio = var5.SelectedLineImageSize.X / var5.SelectedLineImageSize.Y;
			});
		});
	})
end
return require(CorePackages.Packages.RoactRodux).connect(function(arg1) -- Line 46, Named "mapStateToProps"
	return {
