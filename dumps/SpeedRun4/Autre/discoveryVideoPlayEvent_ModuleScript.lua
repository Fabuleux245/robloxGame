...
local tbl_upvr = {
	...
	throttlingPercentage = game:DefineFastInt("DiscoveryVideoPlayEventHundredthsPercent", 0);
	lastUpdated = {25, 4, 23};
...
return function(arg1, arg2) -- Line 34, Named "discoveryVideoPlayEvent"
	--[[ Upvalues[4]:
