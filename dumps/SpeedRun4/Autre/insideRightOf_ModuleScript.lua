...
-- Decompiled on 2025-07-21 08:45:11
-- Luau version 6, Types version 3
-- Time taken: 0.001802 seconds

local toRect_upvr = require(script.Parent.toRect)
local returnValue_upvr = require(script.Parent.returnValue)
return function(arg1, arg2, arg3) -- Line 29, Named "insideRightOf"
	--[[ Upvalues[2]:
	...
	return returnValue_upvr(true, "Was not left of the element", "Was too far left of the element")
end