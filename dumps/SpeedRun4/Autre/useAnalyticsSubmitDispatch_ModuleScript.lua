...
local AnalyticsSubmitContext_upvr = require(script.Parent.AnalyticsSubmitContext)
return function() -- Line 6, Named "useAnalyticsDispatch"
	--[[ Upvalues[2]:
		[1]: React_upvr (readonly)
		[2]: AnalyticsSubmitContext_upvr (readonly)
	]]
	return React_upvr.useContext(AnalyticsSubmitContext_upvr)
end