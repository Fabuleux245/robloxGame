...
local BulkPurchaseReducer_upvr = require(BulkPurchaseApp.Store.Reducers.BulkPurchaseReducer)
local tbl_upvr = {
	themeName = "dark";
	fontName = "gotham";
}
...
local function _() -- Line 47, Named "createStore"
	--[[ Upvalues[2]:
		...
		[2]: BulkPurchaseReducer_upvr (readonly)
	]]
	return Rodux_upvr.Store.new(BulkPurchaseReducer_upvr, nil, {Rodux_upvr.makeThunkMiddleware()})
end
...
local BulkPurchaseApp_upvr = require(BulkPurchaseApp.BulkPurchaseApp)
local ReactRoblox_upvr = require(Parent.ReactRoblox)
return function() -- Line 53, Named "renderBulkPurchaseApp"
	--[[ Upvalues[19]:
		[1]: CoreGui_upvr (readonly)
		[2]: Rodux_upvr (readonly)
		[3]: BulkPurchaseReducer_upvr (readonly)
		...
		[18]: BulkPurchaseApp_upvr (readonly)
		[19]: ReactRoblox_upvr (readonly)
	]]
	local Folder = Instance.new("Folder")
	Folder.Name = "BulkPurchaseApp"
		...
		StyleProvider = React_upvr.createElement(AppStyleProvider_upvr, {
			...
			NetworkProvider = React_upvr.createElement(NetworkContext_upvr.Provider, {
				...
				StoreProvider = React_upvr.createElement(RoactRodux_upvr.StoreProvider, {
					store = Rodux_upvr.Store.new(BulkPurchaseReducer_upvr, nil, {Rodux_upvr.makeThunkMiddleware()});
				}, {
							...
							NewCursorProvider = React_upvr.createElement(CursorProvider_upvr, {}, {
								FocusNavigationProvider = React_upvr.createElement(ReactFocusNavigation_upvr.FocusNavigationContext.Provider, {
									...
									FocusNavigationRegistryProvider = React_upvr.createElement(Provider_upvr, nil, {
										BulkPurchaseApp = React_upvr.createElement(BulkPurchaseApp_upvr);
									});
								});
							});
						});
