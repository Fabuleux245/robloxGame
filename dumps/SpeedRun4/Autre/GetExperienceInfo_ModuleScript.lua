...
local var5_upvr = require(Parent.createInspectAndBuyKeyMapper)("getExperienceInfo")
...
return function(arg1) -- Line 23, Named "GetExperienceInfo"
	--[[ Upvalues[9]:
	...
	return Thunk_upvr.new(script.Name, module_upvr, function(arg1_2, arg2) -- Line 26
		--[[ Upvalues[8]:
			[1]: Network_upvr (copied, readonly)
			[2]: var5_upvr (copied, readonly)
			[3]: tostring_result1_upvw (read and write)
		...
		local var14_upvr = arg2[Network_upvr]
		return PerformFetch_upvr.Single(var5_upvr(arg1_2:getState().storeId, tostring_result1_upvw), function() -- Line 31
			--[[ Upvalues[7]:
				[1]: var14_upvr (readonly)
				[2]: tostring_result1_upvw (copied, read and write)
			...
			return var14_upvr.getExperienceInfo(tostring_result1_upvw):andThen(function(arg1_3) -- Line 32
				--[[ Upvalues[5]:
				...
				arg1_2:dispatch(SetExperienceInfo_upvr(ExperienceInfo_upvr.fromGetExperienceInfo(arg1_3.data[1])))
				arg1_2:dispatch(SendCounter_upvr(Constants_upvr.Counters.GetExperienceInfo..Constants_upvr.CounterSuffix.RequestSucceeded))
			end, function(arg1_4) -- Line 40
				--[[ Upvalues[3]:
					[1]: arg1_2 (copied, readonly)
					[2]: SendCounter_upvr (copied, readonly)
					[3]: Constants_upvr (copied, readonly)
				]]
				arg1_2:dispatch(SendCounter_upvr(Constants_upvr.Counters.GetExperienceInfo..Constants_upvr.CounterSuffix.RequestRejected))
			end)
		end)(arg1_2):catch(function(arg1_5) -- Line 45
			--[[ Upvalues[3]:
				[1]: arg1_2 (readonly)
				[2]: SendCounter_upvr (copied, readonly)
				[3]: Constants_upvr (copied, readonly)
			]]
			arg1_2:dispatch(SendCounter_upvr(Constants_upvr.Counters.GetExperienceInfo..Constants_upvr.CounterSuffix.RequestFailed))
		end)
	end)
end