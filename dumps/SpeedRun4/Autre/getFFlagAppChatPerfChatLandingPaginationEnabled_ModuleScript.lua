...
game:DefineFastFlag("AppChatPerfChatLandingPaginationEnabled", false)
...
return function() -- Line 9
	...
	local game_GetFastFlag_result1 = game:GetFastFlag("AppChatPerfChatLandingPaginationEnabled")
	if game_GetFastFlag_result1 then
		game_GetFastFlag_result1 = AppChatPerfExperimentation_upvr.getChatLandingPaginationEnabled()
