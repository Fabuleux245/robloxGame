...
local BackButtonController_upvr = require(RobloxGui.Modules.Settings.BackButtonController)
local any_extend_result1 = Roact_upvr.PureComponent:extend("MenuBackButton")
...
any_extend_result1.defaultProps = {
	backEnabled = BackButtonController_upvr.hasReturnUniverse();
}
function any_extend_result1.init(arg1) -- Line 33
	--[[ Upvalues[2]:
		[1]: BackButtonController_upvr (readonly)
		[2]: Roact_upvr (readonly)
	]]
	arg1:setState({
		text = BackButtonController_upvr.getMenuText();
	})
	local any_createBinding_result1_5, any_createBinding_result2_2 = Roact_upvr.createBinding(nil)
	arg1.sizeBinding = any_createBinding_result1_5
	arg1.updateSizeBinding = any_createBinding_result2_2
	local any_createBinding_result1_4, any_createBinding_result2_6 = Roact_upvr.createBinding(nil)
	arg1.sizeConstraintBinding = any_createBinding_result1_4
	...
	arg1.visibleBinding = any_createBinding_result1_3
	arg1.updateVisibleBinding = any_createBinding_result2_5
	local any_createBinding_result1, any_createBinding_result2_3 = Roact_upvr.createBinding(nil)
	arg1.buttonHeightBinding = any_createBinding_result1
	arg1.updateButtonHeightBinding = any_createBinding_result2_3
	local any_createBinding_result1_6, any_createBinding_result2_4 = Roact_upvr.createBinding(nil)
	arg1.textSizeBinding = any_createBinding_result1_6
	arg1.updateTextSizeBinding = any_createBinding_result2_4
	local any_createBinding_result1_2, any_createBinding_result2 = Roact_upvr.createBinding(nil)
	arg1.textSizeConstraintBinding = any_createBinding_result1_2
	arg1.updateTextSizeConstraintBinding = any_createBinding_result2
...
function any_extend_result1.didUpdate(arg1, arg2) -- Line 53
...
function any_extend_result1.updateViewport(arg1) -- Line 60
	--[[ Upvalues[3]:
	...
	if arg1.textLabelRef:getValue() and arg1.props.BackBarRef:getValue() then
		arg1.updateSizeConstraintBinding(Vector2.new((arg1.props.BackBarRef:getValue().AbsoluteSize.X) - (arg1.textLabelRef:getValue().AbsolutePosition.X - arg1.props.BackBarRef:getValue().AbsolutePosition.X), math.huge))
	end
end
...
function any_extend_result1.render(arg1) -- Line 88
	--[[ Upvalues[6]:
		...
		[4]: BackButtonController_upvr (readonly)
	...
	local function callback() -- Line 116
		--[[ Upvalues[1]:
			[1]: arg1 (readonly)
		]]
		arg1.updateSizeBinding(arg1.props.HubBar.Size)
	...
	module.SizeConnection = Roact_upvr.createElement(ExternalEventConnection_upvr, tbl)
	local tbl_2 = {
		event = arg1.props.HubBar:GetPropertyChangedSignal("Visible");
	}
	local function callback() -- Line 122
		--[[ Upvalues[1]:
			[1]: arg1 (readonly)
		]]
		arg1.updateVisibleBinding(arg1.props.HubBar.Visible)
	...
	module.ViewportSizeChangedConnection = Roact_upvr.createElement(ExternalEventConnection_upvr, {
		...
		callback = function() -- Line 128, Named "callback"
			--[[ Upvalues[1]:
				[1]: arg1 (readonly)
			]]
			arg1:updateViewport()
	...
	module.ImageButton = Roact_upvr.createElement("ImageButton", {
		...
		Size = arg1.buttonHeightBinding:map(function(arg1_4) -- Line 142
			if arg1_4 then
		...
		[Roact_upvr.Event.MouseEnter] = function(arg1_5) -- Line 152
			--[[ Upvalues[1]:
		...
		[Roact_upvr.Event.MouseLeave] = function(arg1_6) -- Line 156
			--[[ Upvalues[1]:
				[1]: Theme_upvr (copied, readonly)
			]]
		...
		[Roact_upvr.Event.Activated] = function(arg1_7) -- Line 160
			--[[ Upvalues[1]:
				[1]: BackButtonController_upvr (copied, readonly)
			]]
			BackButtonController_upvr.initiateBackButtonTeleport(Enum.AdTeleportMethod.InGameMenuBackButton)
		end;
	}, {
		...
		Frame = Roact_upvr.createElement("Frame", {
			...
			ImageLabel = Roact_upvr.createElement(ImageSetLabel_upvr, {
				Image = Images_upvr["icons/actions/cycleLeft"];
	...
	return Roact_upvr.createElement("Frame", {
		...
		Visible = Roact_upvr.joinBindings({arg1.state.text, arg1.visibleBinding}):map(function(arg1_2) -- Line 98
			--[[ Upvalues[1]:
				[1]: arg1 (readonly)
			]]
			local backEnabled = arg1.props.backEnabled
			if backEnabled then
				backEnabled = false
				if arg1_2[1] ~= nil then
					backEnabled = arg1_2[2]
				end
			end
			return backEnabled
		end);
		Size = Roact_upvr.joinBindings({arg1.sizeBinding, arg1.buttonHeightBinding}):map(function(arg1_3) -- Line 101
			local _1 = arg1_3[1]
			local _2 = arg1_3[2]
			if _1 and _2 then
		...
		[Roact_upvr.Ref] = arg1.props.BackBarRef;
	}, module)
end
