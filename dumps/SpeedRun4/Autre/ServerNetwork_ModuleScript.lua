...
local any_extend_result1 = Roact_upvr.Component:extend("ServerNetwork")
function any_extend_result1.init(arg1, arg2) -- Line 10
	arg1.state = {
		targetNetworkData = arg1.props.ServerNetworkData;
	}
end
...
return require(script.Parent.Parent.Parent.Components.DataConsumer)(any_extend_result1, "ServerNetworkData")