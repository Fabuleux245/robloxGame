...
local any_extend_result1 = Roact_upvr.Component:extend("MainViewServerJobs")
function any_extend_result1.init(arg1) -- Line 17
	...
	function arg1.onSearchTermChanged(arg1_3) -- Line 24
		...
		arg1.props.dispatchServerJobsUpdateSearchFilter(arg1_3, {})
	end
...
local ServerJobsChart_upvr = require(Components.ServerJobs.ServerJobsChart)
function any_extend_result1.render(arg1) -- Line 51
	--[[ Upvalues[5]:
		...
		[5]: ServerJobsChart_upvr (readonly)
	]]
	local size = arg1.props.size
	local jobsSearchTerm = arg1.props.jobsSearchTerm
	...
	if 0 < utilTabHeight then
		...
		var23 = var23(ServerJobsChart_upvr, {
			size = UDim2.new(1, 0, 1, -utilTabHeight);
			searchTerm = jobsSearchTerm;
			layoutOrder = 2;
		})
	end
	module.ServerJobs = var23
...
local ServerJobsUpdateSearchFilter_upvr = require(script.Parent.Parent.Parent.Actions.ServerJobsUpdateSearchFilter)
return require(CorePackages.Packages.RoactRodux).UNSTABLE_connect2(function(arg1, arg2) -- Line 91, Named "mapStateToProps"
	return {
		jobsSearchTerm = arg1.ServerJobsData.jobsSearchTerm;
	}
	...
	return {
		dispatchServerJobsUpdateSearchFilter = function(arg1_4, arg2) -- Line 99, Named "dispatchServerJobsUpdateSearchFilter"
			--[[ Upvalues[2]:
				[1]: arg1 (readonly)
				[2]: ServerJobsUpdateSearchFilter_upvr (copied, readonly)
			]]
			arg1(ServerJobsUpdateSearchFilter_upvr(arg1_4, arg2))
		end;
	}
