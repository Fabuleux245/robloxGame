...
return function() -- Line 11
	...
	useEffect_upvr(function() -- Line 14
		...
		local any_Connect_result1_upvr = UserInputService_upvr:GetPropertyChangedSignal("OnScreenKeyboardVisible"):Connect(function() -- Line 16
			--[[ Upvalues[2]:
				[1]: useState_upvr_result2_upvr (copied, readonly)
				[2]: UserInputService_upvr (copied, readonly)
			]]
			useState_upvr_result2_upvr(UserInputService_upvr.OnScreenKeyboardVisible)
		end)
