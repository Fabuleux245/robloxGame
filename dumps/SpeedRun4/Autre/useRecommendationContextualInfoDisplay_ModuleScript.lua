...
-- Decompiled on 2025-07-21 10:28:13
...
local getRecommendationContextualInfoDisplay_upvr = require(SocialCommon.Utils.getRecommendationContextualInfoDisplay)
return function(arg1) -- Line 34
	--[[ Upvalues[5]:
		...
		[5]: getRecommendationContextualInfoDisplay_upvr (readonly)
	]]
	...
	if FFlagFriendsRenameSocgraph_upvr and not FFlagFriendsRenameSocgraphEnabledForAll_upvr then
		...
		var9 = var9(function(arg1_2) -- Line 36
	...
	-- KONSTANTERROR: [18] 19. Error Block 84 start (CF ANALYSIS FAILED)
	;({}).singularMutualConnection = nil
	if FFlagFriendsRenameSocgraph_upvr and var9 or FFlagFriendsRenameSocgraphEnabledForAll_upvr then
		local tbl = {
			numConnections = arg1.mutualFriendsCount;
			"Feature.Friends.Label.MutualConnections"
		}
		-- KONSTANTWARNING: GOTO [37] #33
	end
	-- KONSTANTERROR: [18] 19. Error Block 84 end (CF ANALYSIS FAILED)
end