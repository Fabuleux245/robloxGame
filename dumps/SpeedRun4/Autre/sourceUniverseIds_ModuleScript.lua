...
-- Decompiled on 2025-07-21 10:06:58
...
return function(arg1) -- Line 17
	...
	return Rodux_upvr.createReducer(module_2_upvr, {
		...
		[friendsNetworking.DeclineFriendRequestFromUserId.Succeeded.name] = function(arg1_3, arg2) -- Line 29
			--[[ Upvalues[1]:
				[1]: removeIdsFromRequestsStore_upvr (copied, readonly)
			]]
			return removeIdsFromRequestsStore_upvr(arg1_3, arg2.ids)
		end;
		[friendsNetworking.GetFriendRequests.Succeeded.name] = function(arg1_4, arg2) -- Line 37
			--[[ Upvalues[1]:
				[1]: llama_upvr (copied, readonly)
			]]
			local module = {}
			for _, v in pairs(arg2.responseBody.data) do
				module[tostring(v.id)] = v.friendRequest.sourceUniverseId
			end
			return llama_upvr.Dictionary.join(arg1_4, module)
		end;
		[FriendRequestCreated_upvr.name] = function(arg1_5, arg2) -- Line 52
			--[[ Upvalues[1]:
				[1]: llama_upvr (copied, readonly)
			]]
			return llama_upvr.Dictionary.join(arg1_5, {
				[tostring(arg2.requesteeId)] = arg2.sourceUniverseId;
			})
		end;
		[FriendRequestDeclined_upvr.name] = function(arg1_6, arg2) -- Line 60
			--[[ Upvalues[1]:
				[1]: removeIdsFromRequestsStore_upvr (copied, readonly)
			]]
