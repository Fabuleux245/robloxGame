...
local var5_upvr = require(Parent.createInspectAndBuyKeyMapper)("getProductInfo")
...
return function(arg1) -- Line 21, Named "GetProductInfo"
	--[[ Upvalues[9]:
	...
	return Thunk_upvr.new(script.Name, module_upvr, function(arg1_2, arg2) -- Line 22
		...
		return PerformFetch_upvr.Single(var5_upvr(arg1_2:getState().storeId, arg1), function() -- Line 27
			--[[ Upvalues[7]:
			...
			return var13_upvr.getProductInfo(arg1):andThen(function(arg1_3) -- Line 28
				--[[ Upvalues[5]:
					[1]: AssetInfo_upvr (copied, readonly)
					[2]: arg1_2 (copied, readonly)
					[3]: SetAssets_upvr (copied, readonly)
					[4]: SendCounter_upvr (copied, readonly)
					[5]: Constants_upvr (copied, readonly)
				]]
				arg1_2:dispatch(SetAssets_upvr({AssetInfo_upvr.fromGetProductInfo(arg1_3)}))
				arg1_2:dispatch(SendCounter_upvr(Constants_upvr.Counters.GetProductInfo..Constants_upvr.CounterSuffix.RequestSucceeded))
				...
				arg1_2:dispatch(SendCounter_upvr(Constants_upvr.Counters.GetProductInfo..Constants_upvr.CounterSuffix.RequestRejected))
			end)
		end)(arg1_2):catch(function(arg1_5) -- Line 39
			--[[ Upvalues[3]:
				[1]: arg1_2 (readonly)
				[2]: SendCounter_upvr (copied, readonly)
				[3]: Constants_upvr (copied, readonly)
			]]
			arg1_2:dispatch(SendCounter_upvr(Constants_upvr.Counters.GetProductInfo..Constants_upvr.CounterSuffix.RequestFailed))
		end)
	end)
end