...
-- Decompiled on 2025-07-21 10:36:05
...
return function(arg1) -- Line 11
	...
	return Rodux_upvr.createReducer({}, {
		[arg1.GetExperiencesDetails.Succeeded.name] = function(arg1_2, arg2) -- Line 13
			--[[ Upvalues[1]:
				[1]: Cryo_upvr (copied, readonly)
			]]
			return Cryo_upvr.Dictionary.join(arg1_2, {
				[arg2.ids[1]] = arg2.responseBody.data[1];
			})
		end;
		[arg1.GetExperiencesDetails.Failed.name] = function(arg1_3, arg2) -- Line 24
			return arg1_3
		end;
	})
end