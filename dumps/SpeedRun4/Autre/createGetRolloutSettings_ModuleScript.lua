...
-- Decompiled on 2025-07-21 08:56:32
...
return function(arg1) -- Line 6
	...
	return arg1.roduxNetworking.GET({
		Name = "GetRolloutSettings";
	}, function(arg1_2, arg2) -- Line 9
		--[[ Upvalues[1]:
			[1]: CHAT_URL_upvr (copied, readonly)
		]]
		return arg1_2(CHAT_URL_upvr):path("v2"):path("get-rollout-settings"):expandedQueryArgsWithIds("featureNames", arg2)
	end)
end