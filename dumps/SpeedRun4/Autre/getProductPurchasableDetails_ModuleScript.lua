...
-- Decompiled on 2025-07-21 10:50:26
...
return function(arg1, arg2) -- Line 6, Named "getProductPurchasableDetails"
	--[[ Upvalues[2]:
		[1]: Promise_upvr (readonly)
		[2]: PurchaseError_upvr (readonly)
	]]
	return arg1.getProductPurchasableDetails(arg2):andThen(function(arg1_2) -- Line 8
		--[[ Upvalues[1]:
			[1]: Promise_upvr (copied, readonly)
		]]
		return Promise_upvr.resolve(arg1_2)
	end):catch(function(arg1_3) -- Line 11
		--[[ Upvalues[2]:
			[1]: Promise_upvr (copied, readonly)
