...
return function() -- Line 6, Named "useLastInput"
	--[[ Upvalues[2]:
		[1]: React_upvr (readonly)
		[2]: InputMode_upvr (readonly)
	]]
	local any_useState_result1, any_useState_result2_upvr = React_upvr.useState(InputMode_upvr.last)
	React_upvr.useEffect(function() -- Line 8
		--[[ Upvalues[2]:
			[1]: any_useState_result2_upvr (readonly)
			[2]: InputMode_upvr (copied, readonly)
		]]
		any_useState_result2_upvr(InputMode_upvr.last)
