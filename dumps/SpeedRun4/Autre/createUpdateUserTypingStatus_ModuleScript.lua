...
-- Decompiled on 2025-07-21 08:56:39
-- Luau version 6, Types version 3
-- Time taken: 0.000794 seconds
...
return function(arg1) -- Line 6
	...
	return arg1.roduxNetworking.POST({
		...
		module.isTyping = arg3
		local module_2 = {}
		module_2[1] = arg2
		return arg1_2(CHAT_URL_upvr):path("v2"):path("update-user-typing-status"):body(module):setStatusIds(module_2)
	end)
end