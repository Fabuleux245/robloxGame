...
local game_DefineFastString_result1_upvr_2 = game:DefineFastString("SquadCoordinationExperienceJoinExperimentLayer", "Party.Coordination.ExperienceJoin")
local game_DefineFastFlag_result1_upvr = game:DefineFastFlag("EnableSquadCoordinationExperienceJoinExperiment4", false)
local function _(arg1) -- Line 15, Named "getIsUserInTreatment"
	--[[ Upvalues[2]:
...
local game_DefineFastFlag_result1_upvr_2 = game:DefineFastFlag("ForceEnableSquadCoordinationExperienceJoin4", false)
local game_DefineFastString_result1_upvr = game:DefineFastString("SquadCoordinationExperienceJoinExperimentVariant", "IsSearchOverlayEnabled")
return {
	getSquadCoordinationExperienceJoinEnabled = function() -- Line 26, Named "getSquadCoordinationExperienceJoinEnabled"
		--[[ Upvalues[5]:
