...
return function(arg1) -- Line 16
	...
	return function(arg1_2) -- Line 17
		...
		GetOutfitName_upvr(arg1):andThen(function(arg1_3) -- Line 18
			--[[ Upvalues[4]:
				[1]: arg1_2 (readonly)
			...
			arg1_2:dispatch(OpenPrompt_upvr(PromptType_upvr.DeleteOutfit, tbl))
		end, function(arg1_4) -- Line 23
			--[[ Upvalues[1]:
				[1]: AvatarEditorService_upvr (copied, readonly)
			]]
			AvatarEditorService_upvr:SignalDeleteOutfitFailed()
		end)
	end
end