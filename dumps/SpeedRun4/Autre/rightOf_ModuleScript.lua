...
-- Decompiled on 2025-07-21 08:45:14
...
return function(arg1, arg2, arg3) -- Line 35, Named "rightOf"
	--[[ Upvalues[2]:
		[1]: toRect_upvr (readonly)
		[2]: returnValue_upvr (readonly)
	]]
	-- KONSTANTWARNING: Variable analysis failed. Output will have some incorrect variable assignments
	local var3 = toRect_upvr(arg1).Min - toRect_upvr(arg2).Max
	local var4
	if var4 then
	...
	return returnValue_upvr(true, "Was not left of the element", "Was to the left of the element")
end