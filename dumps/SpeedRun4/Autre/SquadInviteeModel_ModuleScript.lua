...
-- Decompiled on 2025-07-21 09:41:33
...
function module_upvr.mock(arg1) -- Line 20
	...
	return module_upvr.new({
		invitedAtTimestampMs = var4.invitedAtTimestampMs or 333333;
		userId = var4.userId or 11111111;
	})
end
function module_upvr.format(arg1) -- Line 31
	...
	return module_upvr.new({
		invitedAtTimestampMs = arg1.invitedAtTimestampMs;
		userId = arg1.userId;
	})
end
module_upvr.isValid = t.interface({
	invitedAtTimestampMs = t.number;
	userId = t.number;
})
return module_upvr