...
return function(arg1, arg2) -- Line 13, Named "useContainerFocusBehavior"
	--[[ Upvalues[4]:
	...
	module_2[2] = arg1
	return useComposedRef_upvr(useEventLifecycleRef_upvr(React_upvr.useCallback(function(arg1_2) -- Line 16
		--[[ Upvalues[2]:
			[1]: any_useContext_result1_upvr (readonly)
			[2]: arg1 (readonly)
		]]
		if any_useContext_result1_upvr then
			assert(arg1_2:IsA("GuiObject"), "FocusBehaviors can only be applied to GuiObjects")
			any_useContext_result1_upvr:registerFocusBehavior(arg1_2, arg1)
		end
	end, module), React_upvr.useCallback(function(arg1_3) -- Line 23
		--[[ Upvalues[2]:
			[1]: any_useContext_result1_upvr (readonly)
			[2]: arg1 (readonly)
		]]
		if any_useContext_result1_upvr then
			assert(arg1_3:IsA("GuiObject"), "FocusBehaviors can only be applied to GuiObjects")
			any_useContext_result1_upvr:deregisterFocusBehavior(arg1_3, arg1)
		end
	end, module_2)), arg2)
end