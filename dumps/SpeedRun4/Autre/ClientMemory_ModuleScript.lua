...
local any_extend_result1 = Roact_upvr.Component:extend("ClientMemory")
...
function any_extend_result1.render(arg1) -- Line 10
	...
	return Roact_upvr.createElement(MemoryView_upvr, {
		...
		targetMemoryData = arg1.props.ClientMemoryData;
	})
end
return require(Components.DataConsumer)(any_extend_result1, "ClientMemoryData")