...
local selectConversations_upvr = require(AppChat.Components.ChatLanding.Conversations.Selectors.selectConversations)
return function() -- Line 7
	--[[ Upvalues[2]:
		[1]: useSelector_upvr (readonly)
		[2]: selectConversations_upvr (readonly)
	]]
	return useSelector_upvr(function(arg1) -- Line 8
		--[[ Upvalues[1]:
			[1]: selectConversations_upvr (copied, readonly)
		]]
		return selectConversations_upvr(arg1)
	end)
end