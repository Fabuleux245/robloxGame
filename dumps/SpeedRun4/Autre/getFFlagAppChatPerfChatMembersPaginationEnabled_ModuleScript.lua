...
-- Decompiled on 2025-07-21 09:52:45
-- Luau version 6, Types version 3
-- Time taken: 0.000667 seconds

game:DefineFastFlag("AppChatPerfChatMembersPaginationEnabled", false)
...
return function() -- Line 9
	...
	local game_GetFastFlag_result1 = game:GetFastFlag("AppChatPerfChatMembersPaginationEnabled")
	if game_GetFastFlag_result1 then
		game_GetFastFlag_result1 = AppChatPerfExperimentation_upvr.getChatMembersPaginationEnabled()
