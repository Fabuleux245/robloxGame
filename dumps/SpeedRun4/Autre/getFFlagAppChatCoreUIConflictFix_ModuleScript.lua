...
-- Decompiled on 2025-07-21 10:24:24
-- Luau version 6, Types version 3
-- Time taken: 0.000423 seconds

game:DefineFastFlag("AppChatCoreUIConflictFix", false)
...
return function() -- Line 5
	...
	local game_GetFastFlag_result1 = game:GetFastFlag("AppChatCoreUIConflictFix")
	if game_GetFastFlag_result1 then
		game_GetFastFlag_result1 = GetFFlagEnableAppChatInExperience_upvr()
	end
