...
-- Decompiled on 2025-07-21 10:12:59
...
return function(arg1) -- Line 24, Named "InGameAssetReportCompleteModal"
	--[[ Upvalues[6]:
	...
	return withLocalization_upvr({
		...
		return React_upvr.createElement("TextButton", {
			...
			Alert = React_upvr.createElement(InteractiveAlert_upvr, {
				...
				title = arg1_2.reportCompleteTitle;
				bodyText = arg1_2.reportCompleteDescription;
				anchorPoint = Vector2.new(0.5, 0.5);
				...
				buttonStackInfo = {
					buttons = {{
						...
						props = {
							...
							text = arg1_2.reportCompleteClose;
						};
					}};
				};
			});
