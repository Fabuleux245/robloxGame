...
-- Decompiled on 2025-07-21 11:01:05
...
local any_extend_result1 = Roact_upvr.PureComponent:extend("MainViewDataStores")
function any_extend_result1.init(arg1) -- Line 17
	...
	function arg1.onSearchTermChanged(arg1_3) -- Line 24
		...
		arg1.props.dispatchDataStoresUpdateSearchFilter(arg1_3, {})
	end
...
local DataStoresChart_upvr = require(Components.DataStores.DataStoresChart)
function any_extend_result1.render(arg1) -- Line 51
	--[[ Upvalues[5]:
		...
		[5]: DataStoresChart_upvr (readonly)
	]]
	local size = arg1.props.size
	local storesSearchTerm = arg1.props.storesSearchTerm
	...
	if 0 < utilTabHeight then
		...
		var23 = var23(DataStoresChart_upvr, {
			size = UDim2.new(1, 0, 1, -utilTabHeight);
			searchTerm = storesSearchTerm;
			layoutOrder = 2;
		})
	end
	module.DataStores = var23
...
local DataStoresUpdateSearchFilter_upvr = require(script.Parent.Parent.Parent.Actions.DataStoresUpdateSearchFilter)
return require(CorePackages.Packages.RoactRodux).UNSTABLE_connect2(function(arg1, arg2) -- Line 91, Named "mapStateToProps"
	return {
		storesSearchTerm = arg1.DataStoresData.storesSearchTerm;
	}
	...
	return {
		dispatchDataStoresUpdateSearchFilter = function(arg1_4, arg2) -- Line 99, Named "dispatchDataStoresUpdateSearchFilter"
			--[[ Upvalues[2]:
				[1]: arg1 (readonly)
				[2]: DataStoresUpdateSearchFilter_upvr (copied, readonly)
			]]
			arg1(DataStoresUpdateSearchFilter_upvr(arg1_4, arg2))
		end;
	}
