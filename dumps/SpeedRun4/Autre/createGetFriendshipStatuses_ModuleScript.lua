...
-- Decompiled on 2025-07-21 10:06:23
...
return function(arg1) -- Line 4
	...
	return arg1.roduxNetworking.GET({
		Name = "GetFriendshipStatuses";
	}, function(arg1_2, arg2) -- Line 9
		--[[ Upvalues[1]:
			[1]: FRIENDS_URL_upvr (copied, readonly)
		]]
		return arg1_2(FRIENDS_URL_upvr):path("v1"):path("users"):id(arg2.currentUserId):path("friends"):path("statuses"):expandedQueryArgsWithIds("userIds", arg2.targetUserIds)
	end)
end