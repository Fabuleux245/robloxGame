...
return require(script.Parent.RoduxNetworking).POST(script, function(arg1, arg2) -- Line 6
	...
	local module = {}
	module.conversation_ids = arg2
	return arg1(CHAT_PLATFORM_BASE_URL_upvr):path("v1"):path("get-conversations-participants-metadata"):body(module):setStatusIds(arg2)
end)