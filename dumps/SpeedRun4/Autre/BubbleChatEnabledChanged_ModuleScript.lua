...
-- Decompiled on 2025-07-21 11:04:41
...
return require(CorePackages.Packages.Rodux).makeActionCreator(script.Name, function(arg1) -- Line 7
	--[[ Upvalues[2]:
		[1]: maybeAssert_upvr (readonly)
		[2]: t_upvr (readonly)
	]]
	maybeAssert_upvr(t_upvr.boolean(arg1))
	local module = {}
	module.enabled = arg1
	return module
end)