...
local any_extend_result1 = Roact_upvr.Component:extend("MainViewActionBindings")
function any_extend_result1.init(arg1) -- Line 17
	...
	function arg1.onSearchTermChanged(arg1_3) -- Line 24
		...
		arg1.props.dispatchActionBindingsUpdateSearchFilter(arg1_3, {})
	end
...
local ActionBindingsChart_upvr = require(Components.ActionBindings.ActionBindingsChart)
function any_extend_result1.render(arg1) -- Line 51
	--[[ Upvalues[5]:
		...
		[5]: ActionBindingsChart_upvr (readonly)
	]]
	local size = arg1.props.size
	local bindingsSearchTerm = arg1.props.bindingsSearchTerm
	...
	if 0 < utilTabHeight then
		...
		var23 = var23(ActionBindingsChart_upvr, {
			size = UDim2.new(1, 0, 1, -utilTabHeight);
			searchTerm = bindingsSearchTerm;
			layoutOrder = 2;
		})
	end
	module.ActionBindings = var23
...
local ActionBindingsUpdateSearchFilter_upvr = require(script.Parent.Parent.Parent.Actions.ActionBindingsUpdateSearchFilter)
return require(CorePackages.Packages.RoactRodux).UNSTABLE_connect2(function(arg1, arg2) -- Line 91, Named "mapStateToProps"
	return {
		bindingsSearchTerm = arg1.ActionBindingsData.bindingsSearchTerm;
	}
	...
	return {
		dispatchActionBindingsUpdateSearchFilter = function(arg1_4, arg2) -- Line 99, Named "dispatchActionBindingsUpdateSearchFilter"
			--[[ Upvalues[2]:
				[1]: arg1 (readonly)
				[2]: ActionBindingsUpdateSearchFilter_upvr (copied, readonly)
			]]
			arg1(ActionBindingsUpdateSearchFilter_upvr(arg1_4, arg2))
		end;
	}
